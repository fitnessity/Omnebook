...
<?php 
  ...
  function timeSlotOptionforservice($lbl) {
...
?>
  	...
  	<div class="panel panel-default">
		...
		<form method="post" action="{{route('add_manual')}}">
						...
						<div class="company-specifics-day" id="selectdays">
							...
							<div class="row">
								...
								<div class="form-group col-md-4 col-sm-6 col-xs-12">
									...
									<?php timeSlotOptionforservice('mon_shift_start'); ?>
								...
								<div class="form-group col-md-4 col-sm-6 col-xs-12">
									...
									<?php timeSlotOptionforservice('mon_shift_end'); ?>
							...
							<div class="row">
								...
								<div class="form-group col-md-4 col-sm-6 col-xs-12">
									...
									<?php timeSlotOptionforservice('tue_shift_start'); ?>
								...
								<div class="form-group col-md-4 col-sm-6 col-xs-12">
									...
									<?php timeSlotOptionforservice('tue_shift_end'); ?>
							...
							<div class="row">
								...
								<div class="form-group col-md-4 col-sm-6 col-xs-12">
									...
									<?php timeSlotOptionforservice('wed_shift_start'); ?>
								...
								<div class="form-group col-md-4 col-sm-6 col-xs-12">
									...
									<?php timeSlotOptionforservice('wed_shift_end'); ?>
							...
							<div class="row">
								...
								<div class="form-group col-md-4 col-sm-6 col-xs-12">
									...
									<?php timeSlotOptionforservice('thu_shift_start'); ?>
								...
								<div class="form-group col-md-4 col-sm-6 col-xs-12">
									...
									<?php timeSlotOptionforservice('thu_shift_end'); ?>
							...
							<div class="row">
								...
								<div class="form-group col-md-4 col-sm-6 col-xs-12">
									...
									<?php timeSlotOptionforservice('fri_shift_start'); ?>
								...
								<div class="form-group col-md-4 col-sm-6 col-xs-12">
									...
									<?php timeSlotOptionforservice('fri_shift_end'); ?>
							...
							<div class="row">
								...
								<div class="form-group col-md-4 col-sm-6 col-xs-12">
									...
									<?php timeSlotOptionforservice('sat_shift_start'); ?>
								...
								<div class="form-group col-md-4 col-sm-6 col-xs-12">
									...
									<?php timeSlotOptionforservice('sat_shift_end'); ?>
							...
							<div class="row">
								...
								<div class="form-group col-md-4 col-sm-6 col-xs-12">
									...
									<?php timeSlotOptionforservice('sun_shift_start'); ?>
								...
								<div class="form-group col-md-4 col-sm-6 col-xs-12">
									...
									<?php timeSlotOptionforservice('sun_shift_end'); ?>
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<textarea id="business_desc" class="panel-textarea" name="business_desc" rows="4" cols="50"></textarea>
