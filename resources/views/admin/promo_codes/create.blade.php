...
@section('content')
    ...
    {!! Form::open(array('id' => 'editPromoCode', 'route' => 'promo_codes.store' , 'files' => true)) !!}
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-xs-12 form-group {{ $errors->has('code') ? ' has-error' : '' }} ">
                        ...
                        {!! Form::text('code', old('code'), ['id' => 'code', 'required' =>'required', 'class' => 'form-control', 'placeholder' => 'Promo Code']) !!}
                        <p class="help-block"></p>
                        @if($errors->has('code'))
                            <p class="help-block">
                                {{ $errors->first('code') }}
                ...
                <div class="row">
                    ...
                    <div class="col-xs-2 form-group {{ $errors->has('code') ? ' has-error' : '' }} ">
                        {!! Form::text('price', old('price'), ['id' => 'price', 'required' =>'required', 'class' => 'form-control', 'placeholder' => 'Price', 'oninput' => "this.value = this.value.replace(/[^0-9.]/g, '');",]) !!}
                    </div>
                </div>
