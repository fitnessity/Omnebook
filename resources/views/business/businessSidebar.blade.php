	  ...
	  <div class="row businessprofile-navigationlink">
	  	<div class="sidebar-title">
			...
			<div class="sidebar-menu-custom">
				<ul>
					<li>
						<span><img src="/public/img/home.png" alt="Omnebook" loading="lazy"></span>
						<a href="{{route('business_dashboard')}}">DASHBOARD</a>
					</li>
					<li>
						<span><img src="/public/img/company-set-up.png" alt="Omnebook" loading="lazy"></span>
						<a>COMPANY SET UP</a>
					...
					<li>
						<span><img src="/public/img/service-price.png" alt="Omnebook" loading="lazy"></span>
					...
					<li>
						<span><img src="/public/img/manage-company.png" alt="Omnebook" loading="lazy"></span>
						<a>MANAGE</a>
						@if($companyId)
					...
					@if($companyId)
					<li>
						<span><img src="/public/img/clients.png" alt="Omnebook"></span>
					...
					<li>
						<span><img src="/public/img/salesreports.png" alt="Omnebook" loading="lazy"></span>
						<a>SALES REPORTS</a>
					</li>
				</ul>
			</div>
  ...
  <div class="row businessprofile-navigationlink">
  	<div class="sidebar-title">
		...
		<div class="sidebar-menu-custom">
			<ul>
				<li>
					<span><img src="{{url('/public/img/home.png')}}" alt="Omnebook" loading="lazy"></span>
					<a href="{{route('business_dashboard')}}">DASHBOARD</a>
				</li>
				<li>
					<span><img src="{{url('/public/img/company-set-up.png')}}" alt="Omnebook" loading="lazy"></span>
					<a>COMPANY SET UP</a>
				...
				<li>
					<span><img src="{{url('/public/img/service-price.png')}}" alt="Omnebook" loading="lazy"></span>
					<a @if($companyId!='') onclick="linkJump(7);" @else href="{{route('createNewBusinessProfile')}}" @endif><div class="navlink1 service-price" id="tab7">SERVICES & PRICES</div></a>
				</li>
				<li>
					<span><img src="{{url('/public/img/manage-company.png')}}" alt="Omnebook" loading="lazy"></span>
					<a>MANAGE</a>
					@if($companyId)
						<a href="{{route('business.schedulers.index')}}"><div class="navlink1 @if(Route::current()->getName()=='business.schedulers.index') tab-active @endif" id="tab9">Manage Bookings</div></a>
						<a href="{{route('business.services.index')}}"><div class="navlink1 @if(Route::current()->getName() == 'business.services.index') tab-active @endif" id="">Manage Service</div></a>
				...
				@if($companyId)
				<li>
					<span><img src="{{url('/public/img/clients.png')}}" alt="Omnebook" loading="lazy"></span>
					<a href="{{route('business_customer_index')}}" class="@if(Route::current()->getName() == 'business_customer_index' || Route::current()->getName() == 'business_customer_show') tab-active @endif"><div class="navlink1 service-price " id="tab12">CLIENTS</div></a>
				</li>
				@endif
				<li>
					<span><img src="{{url('/public/img/email1.png')}}" alt="Omnebook" loading="lazy"></span>
					<a href="{{route('booking_request')}}" class="@if(Route::current()->getName() == 'booking_request') tab-active @endif">INBOX</a>
				</li>
				<li>
					<span><img src="{{url('/public/img/calender.png')}}" alt="Omnebook" loading="lazy"></span>
					<a href="{{route('provider_calendar')}}" class="@if(Route::current()->getName() == 'provider_calendar' ) tab-active @endif">CALENDAR</a>
				</li>
				<li>
					<span><img src="{{url('/public/img/financial-dash.png')}}" alt="Omnebook" loading="lazy"></span>
					<a href="{{route('stripe-dashboard')}}" target="_blank"><div class="navlink1 service-price" id="tab1">FINANCIAL DASHBOARD</div></a> 
				</li>
				<li>
					<span><img src="{{url('/public/img/checkout-register.png')}}" alt="Omnebook" loading="lazy"></span>
				...
				<li>
					<span><img src="{{url('/public/img/salesreports.png')}}" alt="Omnebook" loading="lazy"></span>
					<a>SALES REPORTS</a>
				</li>
			</ul>
		</div>
