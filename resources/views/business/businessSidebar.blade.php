...
// 				$company = CompanyInformation::where('id', $companyId)->get();
			   ...
			   <?php }?>
                ...
                <div class="row businessprofile-navigationlink">
                    ...
                    <?php /*?>
                    <a href="{{route('business-welcome')}}"><div class="navlink1" id="tab1">Activity Schedule</div></a>
                    <a href="{{route('business-welcome')}}"><div class="navlink1" id="tab1">Customers</div></a>
