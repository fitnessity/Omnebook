<div class="modal-header">
    <h5 class="modal-title" id="myModalLabel">View Your bookings</h5>
        ...
        <div class="row g-3 mb-10 align-items-center">
            <div class="col-sm-auto">
                <div class="input-group">
                    <input type="text" class="form-control border-0 dash-filter-picker shadow flatpickr" name="actfildate" id="managecalendarservice" class="form-control" onchange="getbookingmodel();" autocomplete="off" value="{{$date}}">
