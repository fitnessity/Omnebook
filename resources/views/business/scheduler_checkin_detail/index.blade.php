                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-xs-12 col-sm-12">
                                            <div class="scheduled-btns">
                                                <a href="{{route('activity_purchase',['book_id' => 0, 'cus_id' => $booking_checkin_detail->customer_id])}}" class="btn-edit btn-sp">Purchase</a>
                    ...
                    <div class="modal-body body-tbm">
                        ...
                        <div class="row">
                            <form method="post" action="{{route('booking_activity_cancel')}}">
                                ...
                                <input type="hidden" name="pageid" id="pageid" value="{{$business_activity_scheduler->id}}">
