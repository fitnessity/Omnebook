                        ...
                        <div class="h-100">
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="add-photos mt-25">
                                                                                <h3>Add A Video</h3>
                                                                                <ul>
                                                                                    <li>Include a professional video to show the best of what you do</li>
                                                                                    <li>Videos uploaded should show details and people in action.</li>
                                                                                    <li>Take time to plan your video, remove clutter, and background distractions</li>
                                                                                    <li>Think about your music. remove background noise. </li>
                                                                                    <li>Profanity or inappropriate content is prohibited in the videos.</li>
                                                                                </ul>
                                                                                <div class="steps-title">
                                                                                    <div class="mb-3 mt-3">
                                                    ...
                                                    <div class="accordion-item shadow">
                                                        ...
                                                        @csrf
                                                            ...
                                                            <div class="accordion-body">
                                                                ...
                                                                <div class="row mb-15">
                                                                    <div class="col-lg-5 col-md-6 col-xxl-4 col-12">
                                                                ...
                                                                <div class="row mb-15">
                                                                    <div class="col-md-6 col-lg-5 col-xxl-4 col-12">
                                                                        <div class="participant-req">
                                                                            <p>What's the latest a person can book online before the activity starts?</p>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row mb-15">
                                                                    <div class="col-md-6 col-lg-5 col-xxl-4 col-12">
                                                                        <div class="participant-req">
                                                                            <p>Can a customer still book online after the activity has started?</p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3 col-md-3 col-12">
                                                                        <div class="">
                                                                        ...
                                                                        <div class="row @if($serviceType != 'experience') d-none @endif">
                                                                            <div class="col-lg-6">
                                                                                <div class="itinerary-data">
                                                                                    ...
                                                                                    <textarea name="expHighlight" id="ckeditor-classic2">{{@$service->exp_highlight}}</textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                ...
                                                <div class="live-preview" id="faqMainDiv">
                                                    @if(!empty($faqData) && count($faqData) > 0)
                                                        ...
                                                        @foreach($faqData as $i=>$faq)
                                                            <div class="accordion custom-accordionwithicon accordion-border-box mt-3" id="faq{{$i}}">
                                                                <div class="accordion-item shadow">
                                                    ...
                                                    @else
                                                        ...
                                                        <div class="accordion custom-accordionwithicon accordion-border-box mt-3" id="faq0">
                                                            <div class="accordion-item shadow">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header align-items-center d-flex">
                                            <h4 class="card-title mb-0 flex-grow-1 nesting-steps-title">Step 5: Set the price for this program</h4>
                                        </div>
