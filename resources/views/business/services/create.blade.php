                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-lg-3 col-md-6">
                                                                                    <div class="set-price mb-0">
                                                                                        ...
                                                                                        <input name="category_title[]" id="category_title" value="{{$category->category_title}}" class="form-control"  type="text" placeholder="Ex: Kids Martial Arts (5 to 7 yrs Old)">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-3 col-md-6">
                                                                                <div class="set-price mb-0">
                                                                                    ...
                                                                                    <label>Category Title</label>
                                                                                    <input name="category_title[]" id="category_title" class="form-control"  type="text" placeholder="Ex: Kids Martial Arts (5 to 7 yrs Old)">
                                                                                </div>
                                                                            </div>
                                                                        </div>
