...
<body>
	...
	@if(count($expiringMembershipTdy) > 0)
		...
		@include('business.member_expirations.pdf_table_data' , ['memberships'=> $expiringMembershipTdy])
	@endif
    ...
    @if(count($expiringMembershipThd) > 0)
        ...
        @include('business.member_expirations.pdf_table_data' , ['memberships'=> $expiringMembershipThd])
    @endif
    ...
    @if(count($expiringMembershipNid) > 0)
        ...
        @include('business.member_expirations.pdf_table_data' , ['memberships'=> $expiringMembershipNid])
    @endif
    ...
    @if(count($expiringMembershipAll) > 0)
        ...
        @include('business.member_expirations.pdf_table_data' , ['memberships'=> $expiringMembershipAll ])
    @endif
