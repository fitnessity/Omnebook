						...
						<div class="row exclude-from-print mt-5">
							@foreach($sortedDates as $y=>$date)
								@php 
					        		...
					        		$bookingData = $bookingData->whereDate('refund_date',$date->format('Y-m-d'))->get();
								@endphp
											...
											<div class="card-body">
														         	...
														         	<div class="accordion-item shadow">
						                                                ...
						                                                <div id="collapseS{{$counter}}{{$y}}" class="accordion-collapse collapse buttonaccodiandiv" aria-labelledby="headingS{{$counter}}{{$y}}" data-bs-parent="#default-accordion-example">
						                                                   <div class="accordion-body">
						                                                   	@include('business.reports.refund.booking_detail',['bookDetails' =>$data,'dateKey' =>$y ,'loopkey'=>$counter])
						                                                   </div>
						                                                </div>
						                                            </div>
			                                            		 	@php $counter++; @endphp
	                                          ...
	                                          @endif
														...
														@else
															...
															@include('business.reports.refund.booking_detail',['bookDetails' =>$bookingData,'dateKey' =>$y])
														@endif
													</div>
												</div>
											</div>
