                     ...
                     <div class="row mb-3 printnone">
                     	<div class="col-12">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="page-heading">
										<label>Active Memberships Not Being Used</label>
									</div>
								</div><!--end col-->
							</div><!--end row-->
											   ...
											   <div class="live-preview">
	                                                ...
	                                                <div id="collapseS{{$counter}}{{$y}}" class="accordion-collapse collapse buttonaccodiandiv" aria-labelledby="headingS{{$counter}}{{$y}}" data-bs-parent="#default-accordion-example">
	                                                   <div class="accordion-body">
	                                                   	@include('business.reports.membership.table_data',['bookDetails' =>$data, 'business_id' => request()->business_id,'type' => 'notUsed'])
	                                                   </div>
	                                                </div>
	                                             </div>
	                                             @php $counter++; @endphp
...
@include('business.reports.script',['filterStartDate'=>$filterStartDate ,'filterEndDate' =>$filterEndDate ,'page' => 'not_used','excelFileName' =>'Not-Used-Membership.xlsx','pdfFileName' =>'Not-Used-Membership.pdf' ,'downloadUrl' =>$downloadUrl ])
