...
@include('business.reports.script',['filterStartDate'=>$filterStartDate ,'filterEndDate' =>$filterEndDate ,'page' => '','excelFileName' =>'Active-Membership.xlsx','pdfFileName' =>'Active-Membership.pdf' ,'downloadUrl' =>$downloadUrl ])
