                     ...
                     <div class="row mb-3 printnone">
                     	<div class="col-12">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="page-heading">
										<label>Client Birthday List</label>
									</div>
								</div><!--end col-->
							</div><!--end row-->
							...
							<div class="row exclude-from-print mt-5">
								...
								@php 
					        		...
					        		$clientsData = $clientsData->whereMonth('birthdate', '=', $month)->whereDay('birthdate', '=', $day)->get();
								@endphp
	...
	function exportData(){
      ...
      var filename =  '';
		if(type != '' && type != 'print'){
	    	...
	    	if(type == 'excel'){
	    		filename = 'clients-birthday.xlsx';
	    	}else if(type == 'pdf'){
	    		filename = 'clients-birthday.pdf';
	    	}
