				...
				<div class="step-forms">
					...
					<form id="msform">
						...
						<fieldset>
							...
							<div class="radio-block">
								<div class="radio-content">
									<input id="radio1" type="radio" name="radio1" checked>
									<label for="radio1"><span></span> Best choice</label>
								</div><br>
								<div class="radio-content">
									<input id="radio2" type="radio" name="radio" />
									<label for="radio2"><span></span> Second choice</label>
								</div><br>
								<div class="radio-content">
									<input id="radio3" type="radio" name="radio" />
									<label for="radio3"><span></span> Third choice</label>
								</div><br>
								<div class="radio-content">
									<input id="radio4" type="radio" name="radio" />
									<label for="radio4"><span></span> Fourth choice</label>
								</div><br>
								<div class="radio-content">
									<input id="radio6" type="radio" name="radio" />
									<label for="radio6"><span></span> Worst choice</label>
								</div>
							</div>
						...
						<fieldset>
							...
							<div class="radio-block">
								<div class="radio-content">
									<input id="radio7" type="radio" name="radio2" checked>
									<label for="radio7"><span></span> Best choice</label>
								</div><br>
								<div class="radio-content">
									<input id="radio8" type="radio" name="radio" />
									<label for="radio8"><span></span> Second choice</label>
								</div><br>
								<div class="radio-content">
									<input id="radio9" type="radio" name="radio" />
									<label for="radio9"><span></span> Third choice</label>
								</div><br>
							</div>
						...
						<fieldset>
							...
							<div class="radio-block">
								<div class="radio-content">
									<input id="radio10" type="radio" name="radio3" checked>
									<label for="radio10"><span></span> Best choice</label>
								</div><br>
								<div class="radio-content">
									<input id="radio11" type="radio" name="radio" />
									<label for="radio11"><span></span> Second choice</label>
								</div><br>
								<div class="radio-content">
									<input id="radio12" type="radio" name="radio" />
									<label for="radio12"><span></span> Third choice</label>
								</div><br>
								<div class="radio-content">
									<input id="radio13" type="radio" name="radio" />
									<label for="radio13"><span></span> Fourth choice</label>
								</div><br>
							</div>
							<input type="button" name="previous" class="previous action-button" value="Previous" />
							<input type="button" name="next" class="next action-button" value="Next" />
