    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="d-flex p-a15 dashed-border">
                    ...
                    <div class="col-lg-12">
                        <div class="d-flex p-a15 dashed-border">
                            <div class="cred w-50px mr-5">  </div>
...
<!-- Modal -->
<div class="modal fade" id="update_modal" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel1" aria-hidden="true">
