...
<div class="row y-middle">
    <div class="col-lg-12 col-md-12 col-12">
        <div class="mb-15">
            <span class="text-center">Payment for ${{request()->total_amount}}</span>
        </div>
    </div>
</div>


<form id="payment-form" data-secret="{{$intent['client_secret']}}" style="padding: 16px;margin-bottom: 0px;" action="{{route('checkin.autopay_payment_multiple')}}" method="POST" class="validation" data-cc-on-file="false"  data-stripe-publishable-key="{{ env('STRIPE_PKEY') }}" >
    @csrf
    ...
    <input type="hidden" id="price" name="price" value="{{request()->total_amount}}">
    ...
    <input type="hidden" id="id" name="id[]" value="{{request()->rids}}">
    ...
    <div class="text-center mt-10"><button class="btn btn-red align-center" type="submit" id="submit-button">Pay</button></div>
...
<script>
    ...
    // alert('playSoundValues: ' + playSoundValues);
</script>
