...
<link href="http://dev.fitnessity.co//public/dashboard-design/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
					...
					<div class="col-md-8 col-sm-8">
						...
						<div class="cart-btns-continues">
							...
							<div class="btn-cart-info instant-detail-booknow">
								...
								@else
									<a type="submit" class="btn btn-red mt-10" data-bs-toggle="modal" data-bs-target="#cartcheckout">View Cart & Checkout</a>
								@endif
							</div>
						</div>
					</div>
...
<!-- The Modal Checkout-->
<div class="modal fade" id="cartcheckout" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body body-space">
				<div class="row"> 
					...
					<div class="col-lg-12">
						<input type="text" class="form-control border-0 dash-filter-picker flatpiker-with-border flatpickr-range-birthdate flatpickr-input valid active" id="dob" name="dob" placeholder="Birthday" readonly="readonly" aria-invalid="false">
					</div>
				 </div>
            </div>
        </div>
...
<div class="modal fade" id="registermodal"  tabindex="-1" data-bs-focus="false"  role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
...
<script src="http://dev.fitnessity.co//public/dashboard-design/js/bootstrap.bundle.min.js"></script>
