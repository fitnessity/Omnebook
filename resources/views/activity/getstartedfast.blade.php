    ...
    <div class="modal-dialog modal-lg business">
        <div class="modal-content">
			<div class="modal-header" style="text-align: right;"> 
			  	<!-- <div class="closebtn">
					<button type="button" class="close close-btn-design" data-bs-dismiss="modal" aria-label="Close">
...
<div class="modal fade compare-model" id="myModal">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
			<div class="modal-header" style="text-align: right;">
			  <!-- <button class="clear_compare_list" type="button" style="color: white; border-color: red; background-color: red; margin-top: -5px;" data-bs-dismiss="modal">×</button> -->
			  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
