                                ...
                                <div class="tab-pane active" id="nav-current" role="tabpanel" aria-labelledby="nav-current-tab">
                                    ...
                                    @foreach($BookingDetail as $book_details)
                                        ...
                                        <?php
                                            ...
                                            $endtime = @$serviceactdata['shift_end'];
                                            $filter_date = new DateTime();
                                            $filter_date = $filter_date->format("H:i");
                                ...
                                <div class="tab-pane" id="nav-past" role="tabpanel" aria-labelledby="nav-past-tab">
                                    ...
                                    @foreach($BookingDetail as $book_details)
                                        <?php
                                            ...
                                            $filter_date = $filter_date->format("H:i");
                                        ?>
                                        @if( ($endtime < $filter_date) || date('Y-m-d',strtotime($sc_date)) < date('Y-m-d'))
                                            <div class="col-md-4 col-sm-6">
                                                <div class="boxes_arts">
                                                    <div class="headboxes">
                                                        <img src="{{ $pro_pic }}" class="imgboxes" alt="">
...
<script>
    ...
    $( document ).ready(function() {
        ...
        $("input[id=dateserchfilter_today]").change(function(){
            ...
            $.ajax({
                ...
                data:{"_token":"{{csrf_token()}}" ,"date":date ,'type':type,"page":"events"},
    ...
    function getsearchdata(type){
        ...
        $.ajax({
            ...
            data:{"_token":"{{csrf_token()}}" ,"text":text ,"type":type,"page":"events"},
            success: function(data){
                if(type == 'today'){
                    $("#searchbydate_today").html(data);
                }else if(type == 'past'){
