                            ...
                            <div class="addfmaily_block">
                                ...
                                <div class="addfmaily_content">
                                    ...
                                    <div class="row" id="familydiv{{$fam_cnt}}">	
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group">
                                                <select name="gender[{{$fam_cnt}}]" id="gender[{{$fam_cnt}}]" class="form-control">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                            ...
                                            <div class="form-group">
                                                <select name="relationship[{{$fam_cnt}}]" id="relationship[{{$fam_cnt}}]" class="form-control" >
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                            ...
                                            <div class="form-group dob">
                                                ...
                                                <input type="text" name="birthdate[{{$fam_cnt}}]" id="birthdate[{{$fam_cnt}}]" placeholder="Birthday" class="birthdatezebra bdate form-control  birthdatezebra_{{$fam_cnt}}" value="{{$family->birthday}}" required="required">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="mobile[{{$fam_cnt}}]" id="mobile[{{$fam_cnt}}]" placeholder="Mobile" class="form-control" value="{{$family->mobile}}" maxlength="10" onkeypress="return event.charCode >= 48 && event.charCode <= 57" >
                                            </div>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="emergency_contact[{{$fam_cnt}}]" id="emergency_contact[{{$fam_cnt}}]" placeholder="Emergency Contact Number" class="form-control" maxlength="10" value="{{$family->emergency_contact}}" onkeypress="return event.charCode >= 48 && event.charCode <= 57"><input type="text" name="removed_family[{{$fam_cnt}}]" id="removed_family{{$fam_cnt}}" value="" >
                                            </div>
                                    ...
                                    <div class="row" id="familydiv{{$fam_cnt}}" >
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                            ...
                                            <div class="form-group dob">
                                                <label>mm-dd-yyyy</label>
                                                <input type="text"  name="birthdate[{{$fam_cnt}}]" id="birthdate[{{$fam_cnt}}]" placeholder="Birthday" class="birthdatezebra form-control birthdatezebra_{{$fam_cnt}}" required="required">
                                                <script type="text/javascript" >
                                                $('.birthdatezebra_'+{{$fam_cnt}}).Zebra_DatePicker({
                                                    format: 'm/d/Y',
                                                    default_position: 'below'
