									...
									<div class="row y-middle border-bottom-documents mt-5">
										...
										<div  class="col-lg-2 col-md-2 col-1">
											@if(!$d->CustomerDocumentsRequested->isEmpty())
												<button type="button" class="btn btn-red float-right mb-5" onclick="openDocumentModal('{{$d->id}}','upload')">Upload Document </button>
							...
							<div class="card-body">							
								...
								<div class="row y-middle border-bottom-documents">
									...
									<div class="col-lg-1 col-md-2 col-3">
										...
										<div>
											<button type="button" class="btn btn-red float-right mb-5 mt-5" onclick="openTermsModal('{{$customer->id}}','{{$customer->refund_sign_path ? Storage::URL($customer->refund_sign_path) :''}}','refund')">Sign </button>
										</div>
										@endif
									</div>
									<div class="col-lg-1 col-md-1 col-2">
								...
								<div class="row y-middle border-bottom-documents">
									...
									<div class="col-lg-1 col-md-2 col-3">
										@if(!@$lastbooking->created_at)
										<div>
											<button type="button" class="btn btn-red float-right mb-5 mt-5" onclick="openTermsModal('{{$customer->id}}','{{$customer->terms_sign_path ? Storage::URL($customer->terms_sign_path) :''}}','terms')">Sign </button>
										</div>
										@endif
									</div>
									<div class="col-lg-1 col-md-1 col-2">
