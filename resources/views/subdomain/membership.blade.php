...
<div class="row">
	...
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
		...
		<div class="activityselect3 special-date mb-15">
			<input type="text" name="actfildate_forcart" id="actfildate_forcart" placeholder="Date" class="form-control birthdate" autocomplete="off"  onchange="updatedetail('{{ $companyId }}','','date','');" >
			{{-- <input type="text" id="managecalendarservice" class="form-control border-0 flatpickr-range flatpiker-with-border flatpickr-input active" readonly="readonly" onchange="updatedetail('{{ $companyId }}' autocomplete="off"> --}}
		</div>
	</div>
...
<script type="text/javascript">
	...
	function updateDropdownIds() {
		$('select[id^="participats_"]').each(function() {
			...
			let newId = `participats_${uniqueIdCounter++}`; 
			$(this).attr('id', newId); 
		});
	}
