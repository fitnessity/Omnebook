...
<?php  
       ...
       // $urlprofile = $url.'profile/viewProfile';
         $urlprofile = '#';
        $logoimg = $url.'public/img/logo-fitness';
                                                                        ...
                                                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td style="text-align: center; padding: 8px 20px 0px;" align="center">
                                                                                    <img src="{{$url}}/public/images/fitnessity_logo1.png" width="249" height="43"  alt="logo" border="0" style="height: auto;">
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </div>
                                                                ...
                                                                <?php } ?>
                                                                            ...
                                                                            <tr>
                                                                                <td style="text-align: center; padding: 0px 28px 30px;" align="center">
                                                                                    ...
                                                                                    <p style="font-weight: 400; font-size: 14px; color: #000000; margin-bottom: 0px; margin-top: 0px; text-align: left;">We welcome you to {{$company_name}}. We invite you to book with us anytime, anywhere with Fitnessity.  </p>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td style="text-align: center; padding: 0px 28px 30px;" align="center">
                                                                                    ...
                                                                                    <ul style="text-align: left; font-size: 14px;margin-top: 0px;">
                                                                                        <li>View and post your own reviews</li>
                                                                                        <li>Gain access to our online programs</li>
                                                                                        <li>Buy our products, gear, apparel and more</li>
                                                                                        <li>Rebook, reschedule or cancel a booking at anytime.</li>
                                                                             ...
                                                                             <tr>
                                                                                <td style="border-radius: 0; background: #ffffff; padding: 0px 0px 25px 0px;">
                                                                                    <a href="{{$providerurl}}" style="background: #606060; font-weight:bold; font-family: sans-serif; font-size: 15px; line-height: 14px; text-decoration: none; padding: 10px 14px; color: #fff; display: inline-block; border-radius: 8px; width: 22%;">Visit Our Page</a>
                                                                                </td>
                                                                            </tr>
                                                                             <tr>
                                                                                <td style="border-radius: 0; background: #ffffff; padding: 0px 0px 25px 0px;">
                                                    ...
                                                    <td dir="ltr" height="100%" valign="top" width="100%" style="font-size:0; padding: 0px 0;  text-align: center; " align="center" valign="center">
                                                        ...
                                                        <div style="display:inline-block; margin: 0 -1px; max-width: 375px; min-width:160px; vertical-align:top;">
                                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="border-spacing:0!important;  border-collapse:collapse!important; table-layout:fixed!important;   margin:0 auto!important">
                                                                <tr>
                                                                    <td dir="ltr" style="font-family: sans-serif; font-size: 15px; line-height: 45px; color: #555555; padding: 20px 20px; text-align: left; height: 90px;" align="center" valign="center">
                                                                        <h2 style="margin: 0 0 5px 0; font-family: 'Poppins',sans-serif; font-size: 20px; line-height: 28px; color: black; font-weight: 400;">Buy Equipment, Apparel, Gear, and More</h2>
                                                                        ...
                                                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="border-spacing:0!important;  border-collapse:collapse!important;  table-layout:fixed!important;  ">
                                                                            <tr>
                                                                                <td style="border-radius: 0; background: #ffffff; padding: 0px 0px 25px 0px;">
                                                                                    <a href="#" style="background: #ef1313; font-weight:bold; font-family: sans-serif; font-size: 15px; line-height: 14px; text-decoration: none; padding: 10px 14px; color: #fff; display: block; border-radius: 8px;">Buy Products</a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        <!-- Button : END -->
