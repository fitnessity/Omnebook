    ...
    <body width="100%" style="margin: 0; padding: 0 !important; background-color:#ede9e6; margin:0 auto!important; padding:0!important; height:100%!important; width:100%!important; font-family:Poppins,Arial,sans-serif">
        ...
        <center role="article" aria-roledescription="email" lang="en" style="width: 100%;">
            <div style="background-color:#ede9e6;">
                                            ...
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                                                            ...
                                                            <tr>
                                                                <td style="text-align: center; background-color: #e4e4e4;">
                                                                    <div>
                                                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td style="text-align: left; padding: 15px; font-size: 13px;">SUBJECT: CONGRATULATIONS <?php echo strtoupper(@$AllDetail['company_data']['company_name']); ?> YOU ARE NOW LIVE ON FITNESSITY
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </div>
                                                ...
                                                <tr>
                                                    <td style=" padding:23px 10px 23px; text-align: center" align="center">
                                                        <h6 style="font-size: 18px; font-weight: 600; color: #000;margin-bottom: 0px;">Finish your profile to reach others looking to book your services </h6>
                                                    </td>
                                                </tr>
                                                <!-- END -->
                                                ...
                                                <tr>
                                                    <td style=" padding:23px 10px 23px; text-align: center" align="center">
                                                        <h6 style="font-size: 15px; font-weight: 550; color: #000;margin-bottom: 0px;">What is Fitnessity? </h6>
                                                ...
                                                <tr>
                                                    <td style=" padding:23px 10px 23px; text-align: center" align="center">
                                                        <h6 style="font-size: 15px; font-weight: 550; color: #000;margin-bottom: 0px;">Is the business information that was provided correct?</h6>
                ...
                <tr>
                    <td style=" padding:23px 10px 23px; text-align: center" align="center">
                        <h6 style="font-size: 15px; font-weight: 550; color: #000;margin-bottom: 0px;">Your First Review on Fitnessity</h6>
						<tr>
                                ...
                                ?>
                                                ...
                                                <tr>
                                                    <td style=" padding:23px 10px 23px;">
                                                        <h6 style="font-size: 15px; font-weight: 550; color: #000;margin-bottom: 0px; text-align: left">How to claim your business profile</h6>
                                                        ...
                                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="follow-us">
                                                            ...
                                                            <tr>
                                                                <td>
    																...
    																<h5 style="color: white; text-align: center; font-weight: 400; margin-top: 0px; margin-bottom: 0px;">@ copyright <?php echo date('Y'); ?> Fitnessity, Inc.</h5>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
