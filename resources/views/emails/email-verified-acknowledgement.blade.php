                                            ...
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                                                ...
                                                <tr>
                                                    <td style="padding: 0  0 18px 10px; text-align: left;">
                                                     <span style="color: black;">Welcome to Fitnessity</span>
                                                    </td>
                                                </tr>
                                                <!-- Email Header : END -->
                                                                        ...
                                                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td style="text-align: center; padding: 8px 20px 0px;" align="center">
                                                                                    <a href="#"  ><img src="{{$url}}public/img/logo-fitness.png" width="249" height="43" alt="logo" border="0" style="height: auto;"></a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </div>
                                                                        ...
                                                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td style="display: flex;">
                                                                                    <img src="{{$url}}public/img/banner-img.jpg" width="749"  alt="logo" border="0" style="height: auto;">
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </div>
                                                                        ...
                                                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td style="text-align: center; padding: 0px 30px;" align="center">
                                                                                    <h6 style="font-weight: 500; font-size: 19px; color: #fff; margin-bottom: 0px; margin-top: 15px;"> WHAT ACTIVITY EXCITES YOU TO STAY ACTIVE? </h6>
                                                ...
                                                <tr>
                                                    ...
                                                    <td dir="ltr" height="100%" valign="top" width="100%" style="font-size:0; padding: 0px 0;  text-align: center; " align="center" valign="center">
                                                        ...
                                                        <div style="display:inline-block; margin: 0 -1px; max-width: 380px; min-width:160px; vertical-align:top;">
