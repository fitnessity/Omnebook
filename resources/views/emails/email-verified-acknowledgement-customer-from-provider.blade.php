                                                                ...
                                                                <td style="text-align: center; background-color: #fff;">
                                                                    <div>
                                                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            ...
                                                                            ?>
                                                                                <img src="{{$businessimg}}" width="276" height="" border="0" alt="alt_text" style="width: 100%; max-width: 70px; max-height: 70px; height: auto; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555; border-radius: 100%;" ></a>
                                                                                <?php } ?>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
