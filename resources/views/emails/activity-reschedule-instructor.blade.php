                                            ...
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                                                ...
                                                <tr>
                                                    <td style="padding: 0  0 18px 10px; text-align: left;">
                                                     <span style="color: black;">Hi {{$insname}}, {{$program_name }} on {{$date}} at {{$time}} at {{$company_name}} Has Been Rescheduled</span>
                                                    </td>
                                                </tr>
                                                <!-- Email Header : END -->
                                                                        ...
                                                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            ...
                                                                            <tr>
                                                                                <td style="text-align: center; padding: 0px 28px 30px;" align="center">
                                                                                    <p style="font-weight: 400; font-size: 14px; color: #000000; margin-bottom: 10px; margin-top: 0px; text-align: left;">Dear,{{$insname}}!  </p>
                                                                                    <p style="font-weight: 400; font-size: 14px; color: #000000; margin-bottom: 10px; margin-top: 0px; text-align: left;">We are happy to inform you that the {{$program_name}} scheduled for {{$date}} at {{$time}} has been reschedule as of {{$date}} at {{$time}}. We have once again reserved you a spot for this activity. If you would like to make other arrangedments or to cancel this booking, please contact us immediatly or cancel from your personal profile portal on Fitnessity.</p>
                                                                                    <p style="font-weight: 400; font-size: 14px; color: #000000; margin-bottom: 10px; margin-top: 0px; text-align: left;">  Please contact {{$provider_name}} if you have any further questions.  </p>
                                                                                    <p style="font-weight: 400; font-size: 14px; color: #000000; margin-bottom: 10px; margin-top: 0px; text-align: left;"> We look forward to serving you again soon. </p>
