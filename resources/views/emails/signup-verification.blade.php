    ...
    <div style="display:none">
        ...
        <section style="padding: 30px 0;">
            <div style="max-width: 960px;margin: 0 auto;text-align: center;">
                ...
                <p style="margin-bottom: 0;">
                    Omnebook is a directory & marketplace connecting consumers to trainers, coaches, classes & active experiences with adventures & Tours. You can participate in activities at local businesses, onlie, or while traveling. OmneBook is for people who believe that an active lifestyle is a necessity.
                </p>
            </div>
        </section>
