												...
												<div class="row">
													<div class="col-sm-auto col-6" id="imgdiv">
														<div class="avatar-lg-custom-two bg-light rounded p-1 mmb-10 mb-10">
															<img src="{{$profilePic}}" alt="Omnebook" class="img-fluid d-block" loading="lazy">
														</div>
													</div>
																	...
																	@forelse($schedule->getInsdata() as $ins)
																			<div class="col-md-2 mb-10">
																				<div class="instructor-img">
																					...
																					<img src="{{$ins->profile_pic_url}}" class="instructor-img-cart" alt="Omnebook" loading="lazy">
																					@else
					...
					<div class="row">	
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="photo-select product-edit user-dash-img mb-10">
								...
								<img src="{{'/images/service-nofound.jpg'}}" class="pro_card_img blah" id="showimg" alt="Omnebook" loading="lazy">
