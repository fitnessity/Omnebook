						...
						<div id="myMobileSidepanel" class="sidepanel mysidepanel">
							<div class="navbar-content ps">
								...
								<ul class="pc-navbar">
									...
									<li class="pc-link">
									   <span class="pc-micon"><img src="{{asset('/public/img/social-profile.png')}}" alt="Omnebook"  loading="lazy"></span><a href="{{route('profile-viewProfile')}}" style="color: white;"> View Personal Profile</a>
									</li>
