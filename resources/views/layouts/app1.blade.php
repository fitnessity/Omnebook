...
<body>
    ...
    <header>
        <div class="col-lg-12">
            <div class="menu_nav">
                <a href="{{ Config::get('constants.SITE_URL') }}/" class="logo"> <img src="{{ asset('public/images/logo.png') }}"> </a>
                <nav id='cssmenu' style='padding-top:12px'>
                    <form id="searchform" method="" action="{{url('/search-result-location')}}">
                        <div>
                            <input autocomplete="off" type="text" name="label" id="label" class="form-control" placeholder="Search by activity or bussiness name"  style="width:300px; float:left; border-radius: 0; margin:0; background-color:#555; color:#fff; border:0">
                ...
                <div class="header-right">
                    ...
                    <button type="button" class="btn-cart">
                        <img src="{{ asset('public/images/cart-icon.png') }}" alt="cart"><span>0</span>
                    </button>
                </div>
            </div>
        </div>
