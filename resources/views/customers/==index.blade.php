								...
								<div class="col-xl-12">
									<div class="card">
										<div class="card-header align-items-center d-flex">
											<h4 class="card-title mb-0 flex-grow-1">Total Members ({{$customerCount}}) | Active Members ({{$activeMembersCount}}) | Inactive Members ({{$inActiveMembersCount}}) |  Prospects ({{$prospectMembersCount}}) | Suspended ({{$suspendCount}}) | Owed ({{$owdCount}}) | At-Risk ({{$atRiskMembersCount}}) | Big Spenders ({{$bigSpenderCount}})</h4>
										</div><!-- end card header -->
										<div class="card-body">
