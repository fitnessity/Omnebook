													...
													<div class="row">
														<div class="col-lg-12">
															<div class="">
																...
																<ul class="nav nav-tabs mb-3" role="tablist">
																	<li class="nav-item">
																		<a class="nav-link @if(request()->customer_type == '') active @endif" href="{{ route('business_customer_index', ['business_id' => request()->business_id]) }}" aria-selected="false">
																			Total Members ({{$customerCount}})
																		</a>
																	</li>
																	<li class="nav-item">
																		<a class="nav-link @if(request()->customer_type == 'active') active @endif" href="{{ route('business_customer_index', ['business_id' => request()->business_id, 'customer_type' => 'active']) }}"  aria-selected="false">
																			Active Members ({{$activeMembersCount}})
																		</a>
																	</li>
																	<li class="nav-item">
																		<a class="nav-link @if(request()->customer_type == 'in-active') active @endif" href="{{ route('business_customer_index', ['business_id' => request()->business_id, 'customer_type' => 'in-active']) }}"  aria-selected="false">
																			Inactive Members ({{$inActiveMembersCount}})
																		</a>
																	</li>
																	<li class="nav-item">
																		<a class="nav-link @if(request()->customer_type == 'prospect') active @endif" href="{{ route('business_customer_index', ['business_id' => request()->business_id, 'customer_type' => 'prospect']) }}"  aria-selected="false">
																			Prospects ({{$prospectMembersCount}})
																		</a>
																	</li>
																	<li class="nav-item">
																		<a class="nav-link @if(request()->customer_type == 'suspended') active @endif"  href="{{ route('business_customer_index', ['business_id' => request()->business_id, 'customer_type' => 'suspended']) }}" role="tab" aria-selected="false">
																			Suspended ({{$suspendCount}})
																		</a>
																	</li>
																	<li class="nav-item">
																		<a class="nav-link @if(request()->customer_type == 'owed') active @endif"  href="{{ route('business_customer_index', ['business_id' => request()->business_id, 'customer_type' => 'owed']) }}" aria-selected="false">
																			Owed ({{$owdCount}})
																		</a>
																	</li>
																	<li class="nav-item">
																		<a class="nav-link @if(request()->customer_type == 'at-risk') active @endif"  href="{{ route('business_customer_index', ['business_id' => request()->business_id, 'customer_type' => 'at-risk']) }}" aria-selected="false">
																			At-Risk ({{$atRiskMembersCount}})
																		</a>
																	</li>
																	<li class="nav-item">
																		<a class="nav-link @if(request()->customer_type == 'big-spenders') active @endif"  href="{{ route('business_customer_index', ['business_id' => request()->business_id, 'customer_type' => 'big-spenders']) }}" aria-selected="false">
																			Big Spenders ({{$bigSpenderCount}})
																		</a>
																	</li>
																</ul>
																<!-- Tab panes -->
