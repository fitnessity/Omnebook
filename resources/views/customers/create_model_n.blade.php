                ...
                <div class="col">
                    <div class="h-100">
                        ...
                        @if ($success == 1)
                            <div class="row mb-3">
                                <div class="page-heading">
                                    <span class="font-green fs-16">Customer Successfully Registered. @if ($successMsg)
                                            {!! $successMsg !!}
                                        @endif </span>
                                </div>
                            </div>
                                        ...
                                        <ul class="nav nav-tabs mb-3" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#add"
                                                    role="tab" aria-selected="false"> Create Account </a>
                                            </li>
                                            <li class="nav-item">
                                                    ...
                                                    <form id="clientRegistration" method="post" action="">
                                                        ...
                                                        <div class="create-customer-box">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4 col-lg-3">
                                                                    <label class="mt-10">Birthday<span
                                                                            id="star">*</span></label>
                                                                    <input type="text"
                                                                ...
                                                                <div class="col-md-4 col-lg-3">
                                                                    <label class="mt-10">Phone <span
                                                                            id="star">*</span></label>
                                                                    <input type="text" name="contact" id="contact"
                                                                        size="30" maxlength="14" autocomplete="off"
                                                                ...
                                                                <div class="col-md-4 col-lg-3">
                                                                    ...
                                                                    <input type="text" name="check_in"
                                                                        id="check_in" size="30" maxlength="4"
                                                                        autocomplete="off"
                                                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                                        class="form-control">
                                                                ...
                                                                <div class="col-md-4 col-lg-3">
                                                                    <div class="form-group check-box-info ">
                                                                        <input class="check-box-primary-account"
                                                                            type="checkbox" id="primaryAccountHolder"
                                                                            name="primaryAccountHolder"
                                                                            value="1">
                                                                        <label for="primaryAccountHolder"> Primary
                                                                            Account <span class=""
                                                                                data-bs-toggle="tooltip"
                                                                                data-bs-placement="top"
                                                                                title="You are paying for yourself and all added family members.">(i)</span></label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4 col-lg-3 mt-10">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        id="addressCustomer" value=""
                                                                        oninput="initMapCall('addressCustomer', 'cityCustomer', 'stateCustomer', 'countryCustomer', 'zipcodeCustomer', 'latitudeCustomer', 'longitudeCustomer')">
                                                                </div>
                                                                <div id="map" style="display: none;"></div>
                                                                <div class="col-md-4 col-lg-3 mt-10">
                                                                    <label for="City">City</label>
                                                                    <input type="text" class="form-control"
                                                                        name="city" id="cityCustomer"
                                                                        size="30" maxlength="50" value="">
                                                                </div>
                                                                <input type="hidden" name="lon"
                                                                    id="longitudeCustomer" value="">
                                                                <input type="hidden" name="lat"
                                                                    id="latitudeCustomer" value="">

                                                                <div class="col-md-4 col-lg-3 mt-10">
                                                                    <label for="state">State</label>
                                                                    <input type="text" class="form-control"
                                                                        name="state" id="stateCustomer"
                                                                        size="30" maxlength="50" value="">
                                                                </div>
                                                                <div class="col-md-4 col-lg-3 mt-10">
                                                                    <label for="country">Country </label>
                                                                    <input type="text" class="form-control"
                                                                        name="country" id="countryCustomer"
                                                                        size="30" maxlength="50" value="">
                                                                </div>
                                                                ...
                                                                <div class="col-md-4 col-lg-3 mt-10">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        name="zipcode" id="zipcodeCustomer"
                                                                        size="30" maxlength="50" value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="create-customer-box">
                                                            <div class="row">
                                                                <div class="col-md-12 col-lg-12">
                                                                    <h4 class="font-red ">Add Family Members (Optional)
                                                                    </h4>
                                                                </div>
                                                                <div class="error mb-10" id="familyerrormessage">
                                                                </div>
                                                                <input type="hidden" name="familycnt" id="familycnt"
                                                                    value="0">
                                                                <div id="familymaindiv">
                                                                    <div class="new-client mb-10" id="familydiv0"
                                                                        data-i="0" data-text="1">
                                                                        <div class="accordion"
                                                                                    ...
                                                                                    <div class="accordion-body">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div
                                                                                                class="col-md-4 col-lg-3">
                                                                                                <label
                                                                                                    class="mt-10">Gender</label>
                                                                                                <select
                                                                                                    name="familygender[]"
                                                                                                    id="gender"
                                                                                                    class="form-select gender"
                                                                                                    required="">
                                                                                                    <option
                                                                                                        value="male">
                                                                                                        Male</option>
                                                                                            ...
                                                                                            <div
                                                                                                class="col-md-4 col-lg-3">
                                                                                                <label
                                                                                                    class="mt-10">Emergency
                                                                                                    Name</label>
                                                                                                <input type="text"
                                                                                                    name="emergency_name[]"
                                                                                                    id="emergency_name"
                                                                                                    class="form-control emergency_name">
                                                                                                <span class="error"
                                                                                                    id="err_emergency_name"></span>
                                                                                            </div>
                                                                                            <div
                                                                                                class="col-md-4 col-lg-3">
                                                                                                <label
                                                                                                ...
                                                                                                <input maxlength="14"
                                                                                                    ...
                                                                                                    id="emergency_phone"
                                                                                                    class="form-control emergency_phone"
                                                                                                    onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"
                                                                                                    data-behavior="text-phone">
                                                                                                <span class="error"
                                                                                                    id="err_emergency_phone"></span>
                                                                                            </div>
                                                                                            <div
                                                                                                class="col-md-4 col-lg-3">
                                                                                                <label
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    id="emergency_email"
                                                                                                    class="form-control emergency_email">
                                                                                                <span class="error"
                                                                                                    id="err_emergency_email"></span>
                                                                                            </div>
                                                                                            <div
                                                                                                class="col-md-4 col-lg-3">
                                                                                                <label
                                                                                                ...
                                                                                                <select
                                                                                                    ...
                                                                                                    class="form-select emergency_relation">
                                                                                                    <option
                                                                                                        value="">
                                                                                                        Select Emergency
                                                                                                        Relationship
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    autocomplete="off"
                                                                                                    onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                                                                    class="form-control check_in_code0"
                                                                                                    onblur="getCode(0,'code');">
                                                                                                <div class="font-red"
                                                                                            ...
                                                                                            <div
                                                                                                class="col-md-4 col-lg-3">
                                                                                                <div
                                                                                                    class="form-group check-box-info">
                                                                                                    <input
                                                                                                        class="check-box-primary-account primaryAcCheck"
                                                                                                        type="checkbox"
                                                                                                        id="primaryAccount"
                                                                                                        name="primaryAccount"
                                                                                                        value="1">
                                                                                                    <label
                                                                                                        ...
                                                                                                        <span
                                                                                                            ...
                                                                                                            data-bs-toggle="tooltip"
                                                                                                            data-bs-placement="top"
                                                                                                            title="Choose the primary account holder to determine whose card covers bookings for up to two family members (e.g., Mom or Dad). All cards stored under the primary account will be available at checkout.">(i)</span></label>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                        ...
                                                        <div class="create-customer-box">
                                                            <div class="row">
                                                                <div class="col-md-12 col-lg-12">
                                                                    <h4 class="font-red ">How did you hear about us
                                                                    </h4>
                                                                </div>
                                                                <div class="container-fuild">
                                                                    <div class="row">
                                                                        <div class="col-md-4 col-lg-3 mt-10">
                                                                            <label class="mt-10">How did you hear
                                                                                about us?</label>
                                                                            <select class="form-control"
                                                                                name="know_from">
                                                                                <option value="male">Search engine
                                                                                    (Google, Bing, etc)</option>
                                                                                <option value="Google maps search">
                                                                                    Google maps search</option>
                                                                                ...
                                                                                <option
                                                                                    ...
                                                                                    Online communities / forums</option>
                                                                                <option value="Online advertisement">
                                                                                    Online advertisement</option>
                                                                                <option value="Offine advertisement">
                                                                                    Offine advertisement</option>
                                                                                <option
                                                                                    value="Noticed the physical location">
                                                                                    Noticed the physical location
                                                                                </option>
                                                        ...
                                                        <div class="create-customer-box">
                                                            <div class="row">
                                                                ...
                                                                <div class="container-fuild">
                                                                    <div class="row">
                                                                        <label class="mt-10">Please pick a password to
                                                                            log-in to your account later.</label>
                                                                        <div class="col-md-4 col-lg-3 mt-10">
                                                                            <label class="mt-10">Password <span
                                                                                    id="star">*</span></label>
                                                                        ...
                                                                        <div class="col-md-4 col-lg-3 mt-10">
                                                                            <label class="mt-10">Confirm Password
                                                                                <span id="star">*</span></label>
                                                                            <input type="text"
                                                                                name="confirmpassword"
                                                                                id="confirmpassword"
                                                                                class="form-control">
                                                                                <div class="confirmpassword_error"></div>
                                                        ...
                                                        <div class="create-customer-box">
                                                            <div class="row">
                                                                            ...
                                                                            <div class="terms-head">
                                                                                <div>
                                                                                    @if ($businessTerms->termcondfaqtext != '')
                                                                                        <a href="#"
                                                                                            data-url="{{ route('getTerms', ['id' => $businessTerms->id, 'termsType' => 'termcondfaqtext', 'termsHeader' => 'Terms, Conditions, FAQ']) }}"
                                                                                            class="font-13 color-red-a"
                                                                                            data-behavior = 'termsModelOpen'>Terms,
                                                                                            Conditions, FAQ</a> |
                                                                                    @endif

                                                                                    @if ($businessTerms->liabilitytext != '')
                                                                                        <a href="#"
                                                                                            data-url="{{ route('getTerms', ['id' => $businessTerms->id, 'termsType' => 'liabilitytext', 'termsHeader' => 'Liability Waiver']) }}"
                                                                                            class="font-13 color-red-a"
                                                                                            data-behavior = 'termsModelOpen'>Liability
                                                                                            Waiver</a> |
                                                                                    @endif

                                                                                    @if ($businessTerms->covidtext != '')
                                                                                        <a href="#"
                                                                                            data-url="{{ route('getTerms', ['id' => $businessTerms->id, 'termsType' => 'covidtext', 'termsHeader' => 'Covid - 19 Protocols']) }}"
                                                                                            class="font-13 color-red-a"
                                                                                            data-behavior = 'termsModelOpen'>Covid
                                                                                            - 19 Protocols</a> |
                                                                                    @endif

                                                                                    @if ($businessTerms->contracttermstext != '')
                                                                                        <a href="#"
                                                                                            data-url="{{ route('getTerms', ['id' => $businessTerms->id, 'termsType' => 'contracttermstext', 'termsHeader' => 'Contract Terms']) }}"
                                                                                            class="font-13 color-red-a"
                                                                                            data-behavior = 'termsModelOpen'>Contract
                                                                                            Terms</a> |
                                                                                    @endif

                                                                                    @if ($businessTerms->refundpolicytext != '')
                                                                                        <a href="#"
                                                                                            data-url="{{ route('getTerms', ['id' => $businessTerms->id, 'termsType' => 'refundpolicytext', 'termsHeader' => 'Refund Policy']) }}"
                                                                                            class="font-13 color-red-a"
                                                                                            data-behavior = 'termsModelOpen'>Refund
                                                                                            Policy</a>
                                                                                    @endif
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                @if (@$businessTerms)
                                                                    <label class="mt-10">To continue, please read the
                                                                        terms & waivers above. A signature is required
                                                                        to participate. </label>
                                                                @endif
                                                                <div class="container-fuild">
                                                                    <div class="row">
                                                                        <div class="col-lg-12">
                                                        ...
                                                        <form id="payment-form1" data-secret="{{ @$clientSecret }}">
                                                            <div>
                                                                ...
                                                                <div id="error-message1"
                                                                    class="alert alert-danger mt-10" role="alert"
                                                                    style="display: none;"></div>
                                                            </div>
                                                            <div class="text-center mt-25">
                                                                <button class="btn btn-red mr-5" type="submit"
                                                                    id="submitStripe">Add on file</button>
                                                                <button type="button" class="btn btn-red"
                                                                    id="skip_next">Skip</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tab-pane" id="search" role="tabpanel">
                                                ...
                                                <div class="row check-txt-center claimyour-business">
                                                    <div class="col-md-10 col-xs-10 col-8 frm-claim">
                                                        <input id="clients_name" style="margin-top:10px;"
                                                            type="text" class="form-control"
                                                            placeholder="Search by typing your clients name"
                                                            autocomplete="off" data-customer-id="">
...
<script type="text/javascript">
        ...
        var drawing = false;
        function startDrawing(e) { alert('hi');
            e.preventDefault();
        ...
        function stopDrawing(e) { alert('stopDrawing');
            e.preventDefault();
            drawing = false;
        }
        function getMouseOrTouchPos(canvas, e) { alert('getMouseOrTouchPos');
                        ...
                        if (response.type === 'success') {
                            if ($('#buttonType').val() == 'skip') {
                                window.location.href =
                                    '/business/{{ $business_id }}/create-customer';
                            } else {
                                setTimeout(function() {
...
<script type="text/javascript">
    ...
    $(document).on("click", '#add_family', function(e) {
        ...
        txtcount++;
        new_cnt++;
        data += '<div class="new-client mb-10" id="familydiv' + new_cnt + '" data-i="' + new_cnt +
            '" data-text="' + txtcount + '" >';
        ...
        $('#deletediv' + new_cnt).html(
            '<div class="setting-icon"> <i class="ri-more-fill"></i> <ul> <li><a onclick="deletediv(' +
            new_cnt +
            ')"><i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i>Delete</a></li></ul></div>');
    ...
    $(document).ready(function() {
        $("#clientRegistration").submit(function() {
            ...
            $('#loading-img').addClass('d-none');
            if($('#firstname').val()=='') {
                $(".fname_error").html('Please Enter First Name.').addClass('font-red alert-class alert-danger');
                return false;
             }
             if($('#lastname').val()=='') {
                $(".lname_error").html('Please Enter Last Name.').addClass('font-red alert-class alert-danger');
                return false;
             }
             if ($('#email').val().trim() == '') {
                $(".email_error").html('Please Enter Email.').addClass('font-red alert-class alert-danger');
                return false;
            } else {
                let email = $('#email').val().trim();
                if (!isValidEmail(email)) {
                    $(".email_error").html('Please Enter a Valid Email.').addClass('font-red alert-class alert-danger');
                    return false;
                }
            }
            if ($('#dob').val() == '') {
            ...
            if ($('#contact').val() == '') {
                $(".phone_error").html('Please Enter Phone number.').addClass('font-red alert-class alert-danger');
                return false;
            }
            if ($('#gender').val() == '') {
                $(".gender_error").html('Please Select Gender.').addClass('font-red alert-class alert-danger');
                return false;
            }
            let password = $('#password').val().trim();
            if (password == '') {
                $(".password_error").html('Please Enter Password.').addClass('font-red alert-class alert-danger');
                return false;
            } else if (password.length < 6) {
                $(".password_error").html('Password must be at least 6 characters long.').addClass('font-red alert-class alert-danger');
                return false;
            }
            
            let confirmPassword = $('#confirmpassword').val().trim();
            if (confirmPassword == '') {
                $(".confirmpassword_error").html('Please Confirm Password.').addClass('font-red alert-class alert-danger');
                return false;
            } else if (password !== confirmPassword) {
                $(".confirmpassword_error").html('Passwords do not match.').addClass('font-red alert-class alert-danger');
                return false;
            }
            if (!jQuery("#b_trm1").is(":checked")) {
                $("#termserror").html('Plese Agree Terms of Service and Privacy Policy.')
                ...
                success: function(response) {
                    ...
                    if (response.type === 'success') {
                        if ($('#buttonType').val() == 'skip') {
                            ...
                            var currentURL =
                                "{{ route('business_customer_create_model') }}";
                            $.ajax({
                                url: currentURL,
                                method: 'GET',
                                dataType: 'json',
    ...
    $(document).ready(function() {
        ...
        $("#clients_name").autocomplete({
            ...
            let profile_img =
                ...
                item.firstname.charAt(0).toUpperCase() + '</p></div></div> ';

            if (item.profile_pic_url) {
                profile_img = '<img class="searchbox-img" src="' + (item.profile_pic ? item.profile_pic :
                    '') + '" style="">';
            }

            var inner_html = '<div class="row rowclass-controller"></div><div class="row"><div class="col-md-3 nopadding text-center">' +
            profile_img + '</div><div class="col-md-9 div-controller">' +
            '<p class="pstyle"><label class="liaddress">' + item.firstname + ' ' + item.lastname + (item.age ? ' (' + item.age + '  Years Old)' : '') + '</label></p>' +
            (item.email ? '<p class="pstyle liaddress">' + item.email + '</p>' : '') +
            (item.phone_number ? '<p class="pstyle liaddress">' + item.phone_number + '</p>' : '') +
            '</div></div>';
    ...
    $(document).on("click", '.request_access_btn', function(e) {
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response == 'already') {
                    $('.errclass').html(
                        "<p> Request access already granted. And user already sync with this business.</p>"
                        );
                    ...
                    $('.errclass').html(
                        '<p>Email Successfully Sent..</p><a class="request_access_btn">Resend Email</a>'
                        );
                } else {
    ...
    function paymentform(customer_id) {
        const stripe1 = Stripe('{{ env('STRIPE_PKEY') }}');
            ...
            stripe1.confirmSetup({
                elements: elements1,
                confirmParams: {
                    return_url: '{{ route('business.customers.refresh_payment_methods_modal',['business_id' => $business_id ])}}?customer_id=' + cus_id,
                }
