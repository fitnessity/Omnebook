																	...
																	<div class="accordion-item shadow">
																		...
																		<div id="accor_nesting2Examplecollapse1" class="accordion-collapse collapse " aria-labelledby="accordionnesting2Example1" data-bs-parent="#accordionnesting2">
																			<div class="accordion-body">
																				...
																				{{-- new suspended membership --}}


																				<div class="accordion nesting12-accordion custom-accordionwithicon accordion-border-box mt-3" id="accordionnesting12">
																					<div class="accordion-item shadow">
																						<h2 class="accordion-header" id="accordionnesting12Example2">
																							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#accor_nesting12Examplecollapse2" aria-expanded="false" aria-controls="accor_nesting12Examplecollapse2">
																								Suspended Memberships ({{$suspended_memberships->count()}})
																							</button>
																						</h2>
