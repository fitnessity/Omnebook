...
$(document).ready(function () {
   ...
   // console.log('hiiii'+locations+'<br/>')
    var map = ''
    var infowindow = ''
    var marker = ''
    var markers = []
    var circle = ''
    $(".card-claimed-businessnew").mouseenter(function () { //console.log('map 1');
        markers[parseInt($(this).attr('myposition'))].setMap(null);
        var icon = {
            url: "https://development.fitnessity.co/public/images/hoverin2.png", // url
		...
		var cname=locations[i][0].replace(/\s+/g, '-');
		
		var stars=0; var rating_count=0;
		if(locations[i][5]>=5)
		{
			rating_count=locations[i][6];
			stars='<li class="fill-str"><i class="fa fa-star"></i></li><li class="fill-str"><i class="fa fa-star"></i></li><li class="fill-str"><i class="fa fa-star"></i></li><li class="fill-str"><i class="fa fa-star"></i></li><li class="fill-str"><i class="fa fa-star"></i></li><li><i class="fa fa-star"></i></li>';
		}
		else if(locations[i][5]>=4 && locations[i][5]<5)
		{
			rating_count=locations[i][6];
			stars='<li class="fill-str"><i class="fa fa-star"></i></li><li class="fill-str"><i class="fa fa-star"></i></li><li class="fill-str"><i class="fa fa-star"></i></li><li class="fill-str"><i class="fa fa-star"></i></li>';
		}
		else if(locations[i][5]>=3 && locations[i][5]<4)
		{
			rating_count=locations[i][6];
			stars='<li class="fill-str"><i class="fa fa-star"></i></li><li class="fill-str"><i class="fa fa-star"></i></li><li class="fill-str"><i class="fa fa-star"></i></li><li><i class="fa fa-star"></i></li><li><i class="fa fa-star"></i></li>';
		}
		else if(locations[i][5]>=2 && locations[i][5]<3)
		{
			rating_count=locations[i][6];
			stars='<li class="fill-str"><i class="fa fa-star"></i></li><li class="fill-str"><i class="fa fa-star"></i></li><li><i class="fa fa-star"></i></li><li><i class="fa fa-star"></i></li><li><i class="fa fa-star"></i></li>';
		}
		else if(locations[i][5]>=1 && locations[i][5]<2)
		{
			rating_count=locations[i][6];
			stars='<li class="fill-str"><i class="fa fa-star"></i></li><li><i class="fa fa-star"></i></li><li><i class="fa fa-star"></i></li><li><i class="fa fa-star"></i></li>';
		}
        ...
        var contents =
			   ...
			   '<a href="/businessprofile/'+cname+'/'+locations[i][3] + '">' + locations[i][0] + '</a>' +
                '<ul>' + stars +
                ...
                '<li><i class="fa fa-star"></i></li>'*/ +
                '<li class="count">'+rating_count+'</li>' +
                '</ul>' +
                '</div>' +
    ...
    $(".card-claimed-businessnew").mouseleave(function () {
        markers[parseInt($(this).attr('myposition'))].setMap(null);
        var icon = {
            url: "https://development.fitnessity.co/public/images/hoverout2.png", // url
            scaledSize: new google.maps.Size(50, 50), // size
            labelOrigin: {x: 25, y: 16}
        };
        marker = new google.maps.Marker({
    ...
    if (locations.length != 0) {  //console.log('!empty');
        ...
        for (i = 0; i < locations.length; i++) {
			...
			{
				rating_count=locations[i][6];
				stars='<li class="fill-str"><i class="fa fa-star"></i></li> <li class="fill-str"><i class="fa fa-star"></i></li><li class="fill-str"><i class="fa fa-star"></i></li><li class="fill-str"><i class="fa fa-star"></i></li><li class="fill-str"><i class="fa fa-star"></i></li>';
			}
			else if(locations[i][5]>=4 && locations[i][5]<5)
			{
				rating_count=locations[i][6];
			...
			{
				rating_count=0;
				stars='<li><i class="fa fa-star"></i></li><li><i class="fa fa-star"></i></li><li><i class="fa fa-star"></i></li><li><i class="fa fa-star"></i></li><li><i class="fa fa-star"></i></li>';
			}
