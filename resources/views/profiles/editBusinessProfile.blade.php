  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
        ...
        <form id="frmregister" method="post" action="/profile/saveEditedProfileHistory" enctype="multipart/form-data">
         ...
         <input type="hidden" name="professional_detail_id" value="{{@$ProfessionalDetail->id}}">
          <?php 
            ...
            $languages  = isset($ProfessionalDetail->languages) ? json_decode($ProfessionalDetail->languages,true) : [];
            $experience_level = isset($ProfessionalDetail->experience_level) ? json_decode($ProfessionalDetail->experience_level,true) : [];
            $personality = isset($ProfessionalDetail->personality) ? json_decode($ProfessionalDetail->personality,true) : [];
            $goals_option = isset($ProfessionalDetail->goals_option) ? json_decode($ProfessionalDetail->goals_option,true) : [];
            $train_to = isset($ProfessionalDetail->train_to) ? json_decode($ProfessionalDetail->train_to,true) : []; 
            $skill_lavel = isset($ProfessionalDetail->skill_lavel) ? json_decode($ProfessionalDetail->skill_lavel,true) : []; 
            $medical_type = isset($ProfessionalDetail->medical_type) ? json_decode($ProfessionalDetail->medical_type,true) : []; 
            $work_locations = isset($ProfessionalDetail->work_locations) ? json_decode($ProfessionalDetail->work_locations,true) : [];
            $hours = isset($ProfessionalDetail->availability) ? json_decode($ProfessionalDetail->availability,true) : [];
            ?>
          ...
          <?php $key = str_replace(' ','_',strtolower($key)); ?>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6 qh-steps-form">
                      <div class="form-control">
                        <div class="btn-group" data-toggle="buttons">
                          <label class="btn btn-primary medicaloption @if(isset($ProfessionalDetail->medical_states) && $ProfessionalDetail->medical_states == 1) active @endif">
                          <input type="radio" value="1" class="chkdy" name="medical_states" autocomplete="off" @if(isset($ProfessionalDetail->medical_states) && $ProfessionalDetail->medical_states == 1) checked @endif>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6 qh-steps-form">
                      <div class="form-control">
                        <div class="btn-group" data-toggle="buttons">
                          <label class="btn btn-primary medicaloption @if(isset($ProfessionalDetail->medical_states) && $ProfessionalDetail->medical_states == 0) active @endif">
                          <input type="radio" value="0" class="chkdy" name="medical_states" autocomplete="off" @if(isset($ProfessionalDetail->medical_states) && $ProfessionalDetail->medical_states == 0) checked @endif>
                          <span class="glyphicon glyphicon-ok"></span> </label>
                          No
                        </div>
                      </div>
                    ...
                    {{--  start  --}}
                    <div class="medicalyesno" style="@if(isset($ProfessionalDetail->medical_states) && $ProfessionalDetail->medical_states == 'no') display: none; @endif">
                  ...
                  <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12 qh-steps-form">
                      <div class="col-md-6 col-sm-6 col-xs-6 qh-steps-form">
                        <div class="form-control">
                          <div class="btn-group" data-toggle="buttons">
                            <label class="btn btn-primary fitgolsop @if(isset($ProfessionalDetail->goals_states) && $ProfessionalDetail->goals_states == 1) active @endif">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-6 qh-steps-form">
                        <div class="form-control">
                          <div class="btn-group" data-toggle="buttons">
                            <label class="btn btn-primary fitgolsop @if(isset($ProfessionalDetail->goals_states) && $ProfessionalDetail->goals_states == 0) active @endif">
                    ...
                    {{--  end row  --}}
                    <span class="fitgolsyesno" style="@if(isset($ProfessionalDetail->goals_states) && $ProfessionalDetail->goals_states == 0) display: none; @endif">
                      <h1 class="step2-title text-left" style="padding-left:15px;text-transform: none;">If Yes, what type? </h1>
          ...
          <div class="step-block1 tab">
              ...
              <div class="sgnup-rates mrgn-md-top">
                <div class="row">
                  ...
                  <div class="col-md-4 col-sm-12 col-xs-12 qh-steps-form">
                    <div class="form-control">
                      <div class="btn-group" data-toggle="buttons">
                        <label class="business_hour_type btn btn-primary @if(isset($ProfessionalDetail->hours) && @$ProfessionalDetail->hours == $bkey) active @endif" @if(@$bkey==0) onclick="javascript:hoursshow();" @endif @if(@$bkey==1 || @$bkey==2 || @$bkey==3) onclick="javascript:hidehoursshow();" @endif >
                        <input type="radio" class="chk" value="<?php echo $bkey; ?>" name="hours_opt" autocomplete="off" @if(isset($ProfessionalDetail->hours) && @$ProfessionalDetail->hours == $bkey) checked @endif>
                        <span class="glyphicon glyphicon-ok"></span> </label>
                        <?php echo $bval; ?>
                      </div>
                    </div>
                ...
                <div class="row" id="hoursshow"  @if(@$ProfessionalDetail->hours !=0) style="display:none" @endif >
                  ...
                  <div class="col-md-6 col-sm-12 col-xs-12 qh-steps-form">
                    ...
                    <div class="form-control">
                      ...
                      <div class="col-sm-1"> &nbsp;-&nbsp;</div>
                      <div class="col-md-5" style="border:1px solid #555;">   
                        <input type="text" class="timepicker" name="hours[saturday_end]" value="{{$hours['saturday_end']}}" autocomplete="off" style="border:none; width:100%">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <h1 style="margin-left:30px">Time Zone</h1>
                    <div class="col-md-6" style="margin-left:20px">
                      <select name="timezone" class="form-control">
                        <option value="est" @if($ProfessionalDetail->timezone=="est") selected @endif> Eastern Standard Time (EST)</option>
                        <option value="cst" @if($ProfessionalDetail->timezone=="cst") selected @endif> Central Standard Time (CST)</option>
                        <option value="mst" @if($ProfessionalDetail->timezone=="mst") selected @endif> Mountain Standard Time (MST)</option>
                        <option value="pst" @if($ProfessionalDetail->timezone=="pst") selected @endif> Pacific Standard Time (PST)</option>
                      </select>
                    </div>
                    <div class="col-md-6">
                    </div>
                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12 qh-steps-form">
                    <div class="form-control">
                      ...
                      <br/>
            {{$ProfessionalDetail->special_days_off}}
                      <div class="btn-group" data-toggle="buttons">
                        <input type="text" class="form-control" name="special_days_off" value="{{$ProfessionalDetail->special_days_off}}" placeholder="Select days" id="mdp-demo" />
            ...
            <?php $note = json_decode($ProfessionalDetail->notice_each_book,true);?>
        ...
        <?php $addv = json_decode($ProfessionalDetail->advance_book,true);?>
                <div class="row">
                  <div class="col-md-6 col-sm-12 col-xs-12 qh-steps-form">
                    <div class="form-control">
                      <div class="select-style">
                    ...
                    <div class="form-control">
                      <span class="travel_miles_div"
                        ...
                        <div class="select-style">
                          ...
                          <option value="<?php echo $key; ?>" @if($key == $ProfessionalDetail->travel_miles) selected @endif ><?php echo $value; ?></option>
                          <?php } ?>
                          </select>
                        </div>
                        How far are you willing to travel out of your zip code?
                  ...
                  <div class="row">
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <div class="table-responsive">
                        ...
                        <table class="uiuuiuiu" id="education_table_l" cellpadding="0" cellspacing="0" border="0" style="width:100%">
                              ...
                              <td valign="middle">
                                <a href="{{url('vetted-business-faq') }}" target="_blank" style="color: red">Vetted Business FAQ's</a><br /><a href="{{ url('background-check-faq') }}" target="_blank" style="color: red">Background Check FAQ's</a>
                              </td>
                              <td valign="middle">
                                &nbsp;
                              </td>
                          ...
                          @if(count($employmenthistories) > 0)
                            <?php $history_index = 0; ?>
                              ...
                              <td valign="middle">
                                ...
                                <input type="text" name="servicestart[]" value="{{ date('d-m-Y', strtotime($employmenthistory->service_start)) }}" class="noborder"  title="servicestart" readonly>
                              </td>
                              <td valign="middle">
                                @if($employmenthistory->is_present)
                                  <?php $service_end = "Till Date"; ?>
                                @else
                                  <?php $service_end = date('d-m-Y', strtotime($employmenthistory->service_end)); ?>
                                @endif
                        ...
                        <table class="table add_education" id="education_table" cellpadding="0" cellspacing="0" border="0">
                          ...
                          @if(count($educations) > 0)
                            <?php $education_index = 0; ?>
                              ...
                              <td valign="middle">
                                <input type="text" name="passingyear[]" value="{{ $education->passing_year }}" class="noborder"  title="passingyear" readonly>
                              </td>
                              <td valign="middle" align="center">
                      ...
                      <div class="modal-content">
                        <div class="modal-body login-pad">
                          ...
                          <div class="signup">
                            ...
                            <input type="numer" maxLength="4" class="frm_passingyear" name="frm_passingyear" placeholder="Year graduated/projected graduation" id="passingyear">
                          ...
                          <table class="table add_education" id="certificate_table" cellpadding="0" cellspacing="0" border="0">
                            ...
                            @if(count($certificates) > 0)
                              <?php $certificate_index = 0; ?>
                                ...
                                <td valign="middle">
                                  <input type="text" name="certificatecompletion[]" value="{{ date('d-m-Y', strtotime($certificate->completion_date)) }}" class="noborder"  title="certificatecompletion" readonly>
                                </td>
                                <td valign="middle" align="center">
                      ...
                      <div class="modal-body login-pad">
                        ...
                        <div class="signup">
                          <div id='systemMessage_certificate'></div>
                            ...
                            <input type="text" name="frm_certificatecompletion_date" placeholder="Completion Date" class="certificate_completion_date"/>
                          ...
                          <table class="table add_education" id="skillaward_table" cellpadding="0" cellspacing="0" border="0">
                            ...
                            @if(@count(@$skillAwards) > 0)
                              <?php $certificate_index = 0; ?>
                                ...
                                <td valign="middle">
                                  <input type="text" name="skillawardcompletion[]" value="{{ date('d-m-Y', strtotime($skillAwards->completion_date)) }}" class="noborder"  title="certificatecompletion" readonly>
                                </td>
                                <td valign="middle" align="center">
...
<!-- skill end -->
          ...
          <div class="step-block1">
            <a href="/profile/viewProfile"><i class="fa fa-angle-double-left"></i> Back to Profile</a>
                    ...
                    <div class="multiples">
                      ...
                      <select name="frm_servicetype[]" id="categ" multiple>
                        ...
                        <?php $servicetype = json_decode($service['servicetype'],true);
                          ?> 
                        <option value='{{$bkey}}' @if(@in_array($bkey,$servicetype)) selected @endif> {{$bval}}</option>
                        @endforeach
                      </select>
                    </div>
                    <div class="multiples">
...
setTimeout(function(){ $('#setnumbermsg').hide() }, 3000);
  ...
  var last_row_id = $("#education_table > tbody > tr:last-child").closest('tr').attr('id');
            ...
            //});
                  ...
                  success: function (response) {
                      ...
                      var newrow = '<tr id="skillaward_'+certificate_count+'">'
                            + '<input type="hidden" name="skillaward_id[]" value="0">'
                            + '<td valign="middle">' 
    ...
    function validateFormEducation()
    {
      ...
      if($("input:text[name='frm_passingyear']").val() == "") {
