...
?>
<div class="right-box">
                       <?php /*?> <div class="pr-verification" style="background-color:transparent;background-image:url('/public/images/get-verified.jpg');background-repeat: no-repeat;background-position: center;background-size: 360px 240px">
            ...
            <div class="widget">
            	<div class="cal-time">
                	<?php
						...
						else if($day=='2'){ $today=$tues.' - '.$tuee; }
						else if($day=='3'){ $today=$weds.' - '.$wede; }
						else if($day=='4'){ $today=$thus.' - '.$thue; }
						else if($day=='5'){ $today=$fris.' - '.$frie; }
						else if($day=='6'){ $today=$sats.' - '.$sate; }
						else if($day=='7'){ $today=$suns.' - '.$sune; }
                ...
                <div class="your-page">
					<dl>
                    	<dt>Monday</dt><dd><?php echo date('h:ia', strtotime($mons)).' - '.date('h:ia', strtotime($mone)); ?></dd>
                        <dt>Tuesday</dt><dd><?php echo date('h:ia', strtotime($tues)).' - '.date('h:ia', strtotime($tuee)); ?></dd>
                        <dt>Wednesday</dt><dd><?php echo date('h:ia', strtotime($weds)).' - '.date('h:ia', strtotime($wede)); ?></dd>
                        <dt>Thursday</dt><dd><?php echo date('h:ia', strtotime($thus)).' - '.date('h:ia', strtotime($thue)); ?></dd>
                        <dt>Friday</dt><dd><?php echo date('h:ia', strtotime($fris)).' - '.date('h:ia', strtotime($frie)); ?></dd>
                        <dt>Saturday</dt><dd><?php echo date('h:ia', strtotime($sats)).' - '.date('h:ia', strtotime($sate)); ?></dd>
                        <dt>Sunday</dt><dd><?php echo date('h:ia', strtotime($suns)).' - '.date('h:ia', strtotime($sune)); ?></dd>
