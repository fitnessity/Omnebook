                              ...
                              <div class="col-md-12">
                                <div id="empdetail{{$i}}">
                                  ...
                                  <div class="col-md-12 col-sm-6 col-xs-12">
                                      ...
                                      <input type="checkbox" style="width: 25px;height: 25px;position: relative;top: 5px;" name="frm_ispresentcheck[]" id="frm_ispresentcheck{{$i}}" 
                                              onchange="checkstillwork(this.value,{{$i}})" <?php if($frm_ispresentcheck[$i] == '0') echo " "; else echo "checked"; ?>>
                                ...
                                <div class="col-md-12">
                                  <div id="empdetail0">
                                    ...
                                    <div class="col-md-12 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <label class=" present_work_btn">
                                        <input type="checkbox" style="width: 25px;height: 25px;position: relative;top: 5px;" name="frm_ispresentcheck[]" id="frm_ispresentcheck0"
                                                onchange="checkstillwork(this.value,0)" checked >
                                                <span>I Still Work Here</span>
                                    ...
                                    <?php $j=0;
                                        if(isset($business_price_details) && count($business_price_details) > 0) {/*print_r($business_price_details);*/
                                            $pay_chk = $pay_session_type = $pay_session = $pay_price = $pay_discountcat = $pay_discounttype = $pay_discount = $pay_estearn = $pay_setnum = $pay_setduration = $pay_after = $recurring_duration =  $recurring_every  = $recurring_price = $membership_type = $category_title = $price_title = $recurring_run_auto_pay_adult  = 
                                                $is_recurring_adult =
                                                $recurring_cust_be_charge_adult = $recurring_every_time_num_adult = $recurring_every_time_adult = $recurring_nuberofautopays_adult = $recurring_happens_aftr_12_pmt_adult = $recurring_client_be_charge_on_adult = "";
                                                $recurring_first_pmt_adult = $recurring_recurring_pmt_adult = $recurring_total_contract_revenue_adult = 0 ;
                                                  $is_recurring_infant =$recurring_run_auto_pay_infant  = $recurring_cust_be_charge_infant = $recurring_every_time_num_infant = $recurring_every_time_infant = $recurring_nuberofautopays_infant = $recurring_happens_aftr_12_pmt_infant = $recurring_client_be_charge_on_infant = "";
                                            ...
                                            foreach($business_price_details as $price){ 
                                               /* print_r($price);*/
                                                ...
                                                if(isset($price['recurring_recurring_pmt_child']) && !empty($price['recurring_recurring_pmt_child'])) {
                                                    $recurring_recurring_pmt = $price['recurring_recurring_pmt_child'];
                                                } 
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                  <div class="modal-header">
                                                    <h5 class="modal-title" id="ModelRecurringTitle">Settt Recurring Payment Option</h5>
                                                  ...
                                                  <div class="modal-body">
                                                    <div class="row">
                                                      <div class="col-md-4">
                                                        ...
                                                        <input type="text" name="recurring_price_{{$i}}{{$j}}" id="recurring_price{{$i}}{{$j}}" class="form-control rcprice" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$price['recurring_price']}}">
                                                      </div>
                                                      <div class="col-md-4">
                                                        <label for="salestax">Every</label>
                                                        <input type="text"  name="recurring_every_{{$i}}{{$j}}" id="recurring_every{{$i}}{{$j}}" class="form-control rcevery" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$price['recurring_every']}}">
                                                      </div>
                                                      <div class="col-md-4">
                                                        <label for="salestax">Duration</label>
                                                        <select name="recurring_duration_{{$i}}{{$j}}" id="recurring_duration{{$i}}{{$j}}" class="form-control rcduration">     
                                                          <option value="">-Select-</option>
                                                          <option <?=($price['recurring_duration']=='Day')?'selected':'' ?>>Day</option>
                                                          <option <?=($price['recurring_duration']=='Week')?'selected':'' ?>>Week</option>
                                                          <option <?=($price['recurring_duration']=='Month')?'selected':'' ?>>Month</option>
                                                        </select>
                                                      </div>
                                                    </div>
                                                  </div>
                                                  <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn button-fitness" data-dismiss="modal">OK</button>
                                                  </div>
                                                </div>
                                            </div>
                                        </div>-->
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <div class="saledate">
                                                                            <select class="form-control" name="client_be_charge_on_adult_{{$i}}{{$j}}" id="client_be_charge_on_adult{{$i}}{{$j}}">
                                                                                ...
                                                                                <!-- <option value="date" @if($recurring_client_be_charge_on_adult == 'date') selected @endif>date</option> -->
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="setting-box">
                                                                <div class="set-border">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <p id="p1_price_adult{{$i}}{{$j}}">${{$price['adult_cus_weekly_price']}}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    ...
                                                                    <input type="hidden" name="total_contract_revenue_adult_{{$i}}{{$j}}" id="total_contract_revenue_adult{{$i}}{{$j}}" value="">
                                                                    <div class="col-md-8">
                                                                        <label>Total Contract Revenue:  </label>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <p id="p_total_contract_revenue_adult{{$i}}{{$j}}"> ${{$price['adult_cus_weekly_price']}}</p>
                                                                    </div>
                                                                </div>
                                                                <!-- <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <div class="saledate">
                                                                            <select class="form-control" name="client_be_charge_on_child_{{$i}}{{$j}}" id="client_be_charge_on_child{{$i}}{{$j}}">
                                                                                ...
                                                                                <!-- <option value="date" @if($recurring_client_be_charge_on_child == 'date') selected @endif>date</option> -->
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="setting-box">
                                                                <div class="set-border">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <p id="p1_price_child{{$i}}{{$j}}">${{$price['child_cus_weekly_price']}}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    ...
                                                                    <input type="hidden" name="first_pmt_child_{{$i}}{{$j}}" id="first_pmt_child{{$i}}{{$j}}" value="${{$recurring_first_pmt_child}}">
                                                                    ...
                                                                    <input type="hidden" name="total_contract_revenue_child_{{$i}}{{$j}}" id="total_contract_revenue_child{{$i}}{{$j}}" value="">
                                                                    <div class="col-md-8">
                                                                        <label>Total Contract Revenue:  </label>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <p id="p_total_contract_revenue_child{{$i}}{{$j}}"> ${{$price['child_cus_weekly_price']}}</p>
                                                                    </div>
                                                                </div>
                                                                <!-- <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <div class="saledate">
                                                                            <select class="form-control" name="client_be_charge_on_infant_{{$i}}{{$j}}" id="client_be_charge_on_infant{{$i}}{{$j}}">
                                                                               ...
                                                                               <!--  <option value="date" @if($recurring_client_be_charge_on_infant == 'date') selected @endif>date</option> -->
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="setting-box">
                                                                <div class="set-border">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <p id="p1_price_infant{{$i}}{{$j}}">${{$price['infant_cus_weekly_price']}}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    ...
                                                                    <input type="hidden" name="total_contract_revenue_infant_{{$i}}{{$j}}" id="total_contract_revenue_infant{{$i}}{{$j}}" value="">
                                                                    <div class="col-md-8">
                                                                        <label>Total Contract Revenue:  </label>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <p id="p_total_contract_revenue_infant{{$i}}{{$j}}"> ${{$price['infant_cus_weekly_price']}}</p>
                                                                    </div>
                                                                </div>
                                                                <!-- <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
