<?php
	...
	$totpost = ProfilePost::where('user_id',$loggedinUser->id)->count();
...
<div class="right-box">
    ...
    <?php
		...
		->where("follower_id", "=", $loggedinUser->id)->orderBy('id','desc')->limit(6)->get(); 
                    ...
                    <li>
                        ...
                        <div class="friend-meta">
							...
							if ($isfollow->count()>0) { echo 'Following'; } 
								...
								if($follow['user_id']!= $loggedinUserorignal->id){
							?>
