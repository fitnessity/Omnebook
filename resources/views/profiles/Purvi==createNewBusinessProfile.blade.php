    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <form id="frmVerified" name="frmVerified" method="POST" action="{{route('addbusinessverification')}}">
                ...
                <div class="container-fluid p-0" id="frmVerifieddiv0" style="display: none;">
                    ...
                    <div class="col-md-12">
                        ...
                        <br/>
                        <br/>
                        <a href="https://www.vettedbiz.com/most-commonly-asked-questions-selling-a-business/" target="_new">Vetted Business FAQ's</a><br/>
                        <a href="https://www.evidentid.com/products/background-checks/" target="_new">Background Check FAQ's</a><br/><br/>
                    </div>
                </div>
            ...
            <form name="creService" id="creService" action="{{route('addbusinessservices')}}" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="userid" id="userid" value="{{Auth::user()->id}}">
                <input type="hidden" name="cid" value="{{Auth::user()->cid}}">
                <input type="hidden" name="serviceid" id="serviceid" value="{{Auth::user()->serviceid}}">
                ...
                <div class="container-fluid p-0" id="creServicediv" style="display: none;">
                    ...
                    <div style="background: black;width: 107%;margin-left: -38px;padding: 6px;">
                        <span class="nav-link1 subtab">PERSONAL TRAINING</span>
                            ...
                            <div class="custome-div col-md-8">
                                ...
                                <label for="test1">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="tab-hed1">Personal Training</div>
                ...
                <div class="container-fluid p-0" id="individualDiv0" style="display: none;">
                    <div class="tab-hed">Create Services & Prices</div>
                    <div style="background: black;width: 107%;margin-left: -38px;padding: 6px;">
                        <span class="individualTxt nav-link1 subtab" style="{{ ($service_type=='individual')?'color:red':'' }}">PERSONAL TRAINING</span>
                        <span class="classesTxt nav-link1 subtab1" style="{{ ($service_type=='classes')?'color:red':'' }}">CLASSES</span>
                        <span class="experienceTxt nav-link1 subtab2" style="{{ ($service_type=='experience')?'color:red':'' }}">EXPERIENCES</span>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label for="frm_programname">Setup the programs for your <span id="lbl_activity">kickboxing</span> service<br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 imgUp">
                                            <div class="imagePreview">
                                                ...
                                                <img src="{{ url('/public/uploads/profile_pic/thumb/'.$profile_pic) }}" class="imagePreview blah" id="showimgservice">
                                                @else
                                                <img src="{{ url('/public/images/default-avatar.png') }}" class="imagePreview blah" id="showimgservice">
                                                @endif
                                            </div>
                    ...
                    <section class="row">
                        <div class="col-md-12">
                            <div class="row" style="padding: 10px 100px;">
                                <div class="col-md-12 text-center">
                                    <h3 style="font-size: 17px;font-weight: bold;">ACTIVITY SCHEDULER</h3>
                                ...
                                <div class="col-md-12 text-center" style="padding: 30px 20px;">
                                    ...
                                    <div id="day-circle">
                                       ...
                                       ?>
                                       <div class="daycircle">
                                           <input type="text" name="activity_days[]" class="activity_days" width="800" value="<?=$activity_days?>" />
                                            <div class="row weekdays" style="justify-content: center;">
                                                <div class="col-sm-1 timezone-round day_circle Sunday dys <?=(str_contains($activity_days, 'Sunday')) ? 'day_circle_fill' : '' ?>">
                                                    <p>Su</p>
                                                </div>
                                                <div class="col-sm-1 timezone-round day_circle Monday dys <?=(str_contains($activity_days, 'Monday')) ? 'day_circle_fill' : '' ?>">
                                                    <p>Mo</p>
                                                </div>
                                                <div class="col-sm-1 timezone-round day_circle Tuesday dys <?=(str_contains($activity_days, 'Tuesday')) ? 'day_circle_fill' : '' ?>">
                                                    <p>Tu</p>
                                                </div>
                                                <div class="col-sm-1 timezone-round day_circle Wednesday dys <?=(str_contains($activity_days, 'Wednesday')) ? 'day_circle_fill' : '' ?>">
                                                    <p>We</p>
                                                </div>
                                                <div class="col-sm-1 timezone-round day_circle Thursday dys <?=(str_contains($activity_days, 'Thursday')) ? 'day_circle_fill' : '' ?>">
                                                    <p>Th</p>
                                                </div>
                                                <div class="col-sm-1 timezone-round day_circle Friday dys <?=(str_contains($activity_days, 'Friday')) ? 'day_circle_fill' : '' ?>">
                                                    <p>Fr</p>
                                                </div>
                                                <div class="col-sm-1 timezone-round day_circle Saturday dys <?=(str_contains($activity_days, 'Saturday')) ? 'day_circle_fill' : '' ?>">
                                                    <p>Sa</p>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-4">
                                                    <? timeSlotOption('shift_start', $shift_start); ?>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <? timeSlotOption('shift_end', $shift_end); ?>
                                                </div>
                                                <div class="form-group col-md-4">
                            ...
                            <div class="row" style="padding: 30px 20px;">
                                ...
                                <div class="col-md-12" style="padding:10px 0">
                                    <div class="col-md-3">
                                        <label for="salestax" class="percentageckeck">
                                            <input type="checkbox" <?=($sales_tax=='salestax')?'checked':''?> value="salestax" name="salestax" id="salestax" required> Sales Tax <a href="#" title="Sales Tax" class="tooltip-custom sp1" data-toggle="tooltip" data-placement="top">?</a>
                                        </label>
                                        <div class="salestaxpercentage" id="salestaxpercentage" style="position: absolute; left: 55%; top:-1px; <?=($sales_tax=='salestax')?'display:block':''?>">
                                            <input type="text" value="<?=$sales_tax_percent?>" name="salestaxpercentage" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="2" class="form-control percentage" required> %
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <label for="duestax" class="percentageckeck">
                                            <input type="checkbox" <?=($dues_tax=='duestax')?'checked':''?> value="duestax" name="duestax" id="duestax" required> Dues Tax <a href="#" title="Dues Tax" class="tooltip-custom sp1" data-toggle="tooltip" data-placement="top">?</a>
                                        </label>
                                        <div class="duestaxpercentage" id="duestaxpercentage" style="position: absolute; left: 55%; top:-1px; <?=($dues_tax=='duestax')?'display:block':''?>">
                                            <input type="text" value="<?=$dues_tax_percent?>" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="2" name="duestaxpercentage" class="form-control percentage" required> %
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 service_price_block">
                                    ...
                                    if(isset($business_price) && count($business_price) > 0) {
                                        ...
                                        $pay_chk = $pay_session_type = $pay_session = $pay_price = $pay_discountcat = $pay_discounttype = $pay_discount = $pay_estearn = $pay_setnum = $pay_setduration = $pay_after = "";    
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                 ...
                                                 <div class="col-md-3">
                                                     ...
                                                     <input type="text" name="pay_price[]" id="pay_price" class="pay_price form-control" value="<?=$pay_price?>">
                                                 </div>
                                                 <div class="col-md-3">
                                             ...
                                             <div class="row" style="padding:10px 0">
                                                 <div class="col-md-12">
                                                     <input type="checkbox" name="pay_chk[]" id="pay_chk" <?=($pay_chk=='on')?'checked':''?>> Is this a recurring payment? If so, set the terms
                                                 </div>
                                             </div>
                                             <div class="row">
                                                 <div class="col-md-4">
                                    ...
                                    ?>
                                        <div class="col-md-12 service_price" style="margin-top:20px; padding-top:10px; float:left; border-top:1px dotted #000;">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <label for="pay_price">Price ($)</label>
                                                    <input type="text" name="pay_price[]" id="pay_price" class="pay_price form-control" required>
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="pay_estearn">Your Estimated Earnings <a href="#" title="The user will earn minus the fitnessity service fee when the user sets the price." class="tooltip-custom sp1" data-toggle="tooltip" data-placement="top">?</a></label>
                                            ...
                                            <div class="row" style="padding:10px 0">
                                                <div class="col-md-12">
                                                    <input type="checkbox" name="pay_chk[]" id="pay_chk"> Is this a recurring payment? If so, set the terms
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
...
$("body").on("click", ".add-another-session", function(){
    var service_price = "";
    service_price += '<div class="col-md-12 service_price" style="margin-top:20px; padding-top:10px; float:left; border-top:1px dotted #000;">';
    ...
    */
    ...
    $("body").on("click", ".daycircle", function(){
        if($("#frm_class_meets").val() == 'Weekly') {
            ...
            //$(this).find('.activity_days').val($(this).find('.weekdays').children(".day_circle_fill").length);
            //console.log($(this).find('.weekdays').children(".day_circle_fill"));
        }
    });
