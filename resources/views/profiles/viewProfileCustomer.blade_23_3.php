...
/* tabs end */
	...
	.selfieresult{ border:1px solid #000;min-height: 240px; }
            ...
            <div class="4img-slider">
                ...
                <!--<section>
                    <div class="container-fluid"> 
                        <div class="row">
                            <div class="col-12">
                                <div class="row">
                                    <div class="col col-sm-3 col-md-3 col-lg-3 p0">
                                        <div class="boot-banner">
                                            <img src="http://fitnessity.co/public/uploads/gallery/720/thumb/homebg_1.9769d15.jpg">
                                            <i class="fa fa-pencil editpic-fs"></i>
                                        </div>
                                    </div>
                                    <div class="col col-sm-3 col-md-3 col-lg-3 p0">
                                        <div class="boot-banner">
                                            <img src="http://fitnessity.co/public/uploads/gallery/720/thumb/1642088853-aerobics.jpg">
                                            <i class="fa fa-pencil editpic-fs"></i>
                                        </div>
                                    </div>
                                    <div class="col col-sm-3 col-md-3 col-lg-3 p0">
                ...
                foreach (array_slice($viewgallery, 0, 4) as $pic) {
                    ?>
                        ...
                        <?php /*?><div class="one" style="width:25%">
                            <img src="/public/uploads/gallery/<?= $loggedinUser->id ?>/thumb/<?= $pic['name'] ?>" height="300">
                            <i class="fa fa-pencil editpic-fs" id="{{$pic['id']}}" imgname="{{$pic['name']}}" data-toggle="modal" data-target="#uploadgalaryPic"></i>
                        </div><?php */?>
                        
                            <div class="one" style="width:{{$width}}%">
                                <img style="padding:0; margin:0;"  width="{{$width}}%" height="300" src="/public/uploads/gallery/<?= $loggedinUser->id ?>/thumb/<?= $pic['name'] ?>" /> <!--<i class="fa fa-trash" aria-hidden="true"></i>-->
                               
                                <i class="fa fa-pencil editpic editpic-fs" id="{{$pic['id']}}"  imgname="{{$pic['name']}}" data-toggle="modal" data-target="#uploadgalaryPic"></i>
                            </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="bnr-information">
                    <h2 style="text-transform: capitalize;">{{$customerName}}<!-- <i class="fa fa-pencil usernameedit" id="{{$customerName}}" style="color: #f53b49" data-toggle="modal" data-target="#editusername"></i>--><!-- <span>Claimed</span> -->
            ...
            <div class="col-lg-4 top-1">
                ...
                <!--   <h5>  <i class="fa fa-star rating-pro"></i><span>5.0 </span>(100) </h5> --> 
                    <div>
                  ...
                  <div class="social">
                       ...
                       <!--  <ul>
                        ...
                        <button onclick="myFunction()" style="background: white;border: none; margin-left: 10px;">Copy URL</button></li>
                         ...
                         <!--<ul>
                            <li><a href="javascript:void(0);">{{$ProfileFavcount}} Favourite </a></li>
                        ...
                        <div class="central-meta item">
                                <div class="user-post">
                                    <div class="friend-info">
                                        <figure>
                                            <img src="/public/images/newimage/nearly1.jpg" alt="">
                                        </figure>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-3 col-lg-3">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="wid-sp">
                        <b> Username: </b> @if(isset($UserProfileDetail['username'])) {{ "@".$UserProfileDetail['username']}} @else - @endif
                    </div>
                    </div>
                </div>
                  <!--  <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="wid-sp">
                               ...
                               /* echo "<pre>";
                                ...
                                exit;*/
                                 ?>
                          @if(count($companies) > 0) <b> Company: </b>  @foreach($companies as $value) {{$value['company_name']}} @if(count($companies) != $loop->iteration) , @endif @endforeach  <a href="/manage/company" title="Manage your company"><i class="fa fa-pencil family_edit" style="color: #f53b49"></i></a>
                          @endif
                            </div>
                        </div>
                    </div>-->
                   <!-- <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="wid-sp">
                            <b> Favorite Activities: </b> @if(isset($UserProfileDetail['favorit_activity'])){{$UserProfileDetail['favorit_activity']}}@else - @endif <a href="/personal-profile/user-profile" title="Update your activity"><i class="fa fa-pencil family_edit" style="color: #f53b49"></i></a>
                            </div>
                        </div>
                    </div>-->
                                ...
                                <div class="tab-pane active" id="tabs-11" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6">
                                            <div class="calendar-tab-content-right">
                                                <h5>Nov. 11,2021</h5>
                                                <p>9:00am - 10:00am(1h)</p>
                                                <p>Spots(4/20)<a href="#">Invite Friend</a></p>
                                            </div>                                      
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6">
                                            <div class="calendar-tab-content-right">
                                                <h5>Nov. 11,2021</h5>
                                                <p>11:00am - 11:30am(30m)</p>
                                                <p>Spots(10/20)<a href="#">Invite Friend</a></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6">
                                            <div class="calendar-tab-content-right">
                                                <h5>Nov. 11,2021</h5>
                                                <p>2:00pm - 3:00am(1h)</p>
                                                <p>Spots(15/20)<a href="#">Invite Friend</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <!-- <div class="row">
                            <div class="col-sm-12 col-lg-12 mt-20">
                                ...
                                <ul class="list-st">
                                  <li class="list-items">
                                    <img src="/public/img/profile.png" width="20" height="20"><a href="#">Profile Views {{$ProfileViewCount}}</a>
                                  </li>
                                  <li class="list-items">
                                    <img src="/public/img/heart.png" width="20" height="20"><a href="#">Favorites {{$ProfileFavcount}} </a>
                                  </li>
                                  <li class="list-items">
                                    <img src="/public/img/heart2.png" width="20" height="20"><a href="#">Followings {{$ProfileFollowcount}}</a>
                                  </li>
                                </ul>
                                <ul class="list-st">
                                  <li class="list-items">
                                    <img src="/public/img/calendar.png" width="20" height="20"><a href="#">Bookings 400</a>
                                  </li>
                                  <!-- <li class="list-items">
                                    <img src="/public/img/share.png" width="20" height="20"><a href="#">Shares 135</a>
                                  </li> 
                                  <li class="list-items">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                ...
                                                                <li class="checkwebcam">
                                                                    ...
                                                                    <button type="button" class="btn btn-light ml-10 @error('selfie') is-invalid @enderror" onclick="return showWebCam()" id="webCamButton" style="color: red;">
                                                                        <b>Take Selfie </b>
                                                                    </button>
                                                                    <!-- <input id="file-input" type="file" onclick="return showWebCam()" id="webCamButton"/> -->
                                                                </li>
                                                                <li class="emojili" >
                                                                    <div class="emojilidiv"> 
                                                                    </div>
                                                                </li>
                                            ...
                                            <div id="cameradiv" style="display:none" class="central-meta postbox">
                                            	<div class="col-md-12 login_wrapper">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                            	<div id="results" class="selfieresult">Your captured image will appear here...</div>
                                                            </div>
														</div>
													</div>  
                                            ...
                                            <!--<div class="promote-baner blackish low-opacity">
                                                <div class="bg-image" style="background-image: url(/public/images/newimage/coming-soon-bg.jpg)"></div>
                                                    <span>Create Your Goal and boostup your posts, content, and get more contacts and comments</span>
                                                        <ul class="ads-links">
                                                            <li><a href="#"><i class="fa fa-edit"></i> Choose a Goal</a></li>
                                                        </ul>
                                            </div>-->
                                                                ...
                                                                <div class="story-postbox">
                                                                    <div class="row">
                                                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                                                            <div class="story-box">
                                                                                <figure>
                                                                                    <img src="/public/images/newimage/story-1.jpg" alt="">
                                                                        ...
                                                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                                                            <div class="story-box">
                                                                                <figure>
                                                                                    <img src="/public/images/newimage/story-2.jpg" alt="">
                                                                                    <span>Adam James</span>
                                                                                </figure>
                                                                                <div class="story-thumb" data-toggle="tooltip" title="Adam James">
                                                                                    <img src="/public/images/newimage/thumb-2.jpg" alt="">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                                                            <div class="story-box">
                                                                                <figure>
                                                                                    <img src="/public/images/newimage/story-3.jpg" alt="">
                                                                                    <span>Emily grey</span>
                                                                                </figure>
                                                                                <div class="story-thumb" data-toggle="tooltip" title="Emily grey">
                                                                                    <img src="/public/images/newimage/thumb-3.jpg" alt="">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                                                            <div class="story-box">
                                                                                <figure>
                                                                                    <img src="/public/images/newimage/story-4.jpg" alt="">
                                                                                    <span>Jhon Deo</span>
                                                                                </figure>
                                                                                <div class="story-thumb" data-toggle="tooltip" title="Jhon Deo">
                                                                                    <img src="/public/images/newimage/thumb-4.jpg" alt="">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-lg-4">
                                                                                    <div class="stories-users">
                                                                                        <h5>Stories</h5>
                                                                                        <div class="my-status">
                                                                                            <figure><img src="/public/images/newimage/friend-avatar10.jpg" alt=""></figure>
                                                                                        ...
                                                                                        <ul class="frnds-stories">
                                                                                            <li>
                                                                                                <figure><img src="/public/images/newimage/friend-avatar11.jpg" alt=""></figure>
                                                                                                <div class="story-user">
                                                                                            ...
                                                                                            <li>
                                                                                                <figure><img src="/public/images/newimage/friend-avatar15.jpg" alt=""></figure>
                                                                                                <div class="story-user">
                                                                                            ...
                                                                                            <li>
                                                                                                <figure><img src="/public/images/newimage/friend-avatar12.jpg" alt=""></figure>
                                                                                                <div class="story-user">
                                                                                            ...
                                                                                            <li>
                                                                                                <figure><img src="/public/images/newimage//friend-avatar13.jpg" alt=""></figure>
                                                                                                <div class="story-user">
                                                                                            ...
                                                                                            <li>
                                                                                                <figure><img src="/public/images/newimage/friend-avatar14.jpg" alt=""></figure>
                                                                                                <div class="story-user">
                                                                                                    <span>Zing Jang</span>
                                                                                                    <ins>2 days ago</ins>
                                                                                                </div>
                                                                                            ...
                                                                                            <li>
                                                                                                <figure><img src="/public/images/newimage/friend-avatar16.jpg" alt=""></figure>
                                                                                                <div class="story-user">
                                            ...
                                            <div class="loadMore">
                                                                        ...
                                                                        <li class="post-comment">
                                                                            ...
                                                                            <div class="post-comt-box">
                                                                                <form method="post" id="commentfrm">
                                                                                    ...
                                                                                    <button style="background-color: #f91942" id="{{$profile_post->id}}" class="postcomment" type="button">Post</button>
                                                                                </form> 
                                                                            </div>
                                                                        </li>
                                                                    </ul>
                                                    ...
                                                    <div class="user-post">
                                                        <div class="friend-info">
                                                            ...
                                                            <div class="friend-name">
                                                                ...
                                                                <ins><a href="#" title="">Digital Market</a></ins>
                                                                <span>sponsored <i class="fa fa-globe"></i></span>
                                                            </div>
                                                            <div class="post-meta">
                                                                <figure>
                                                                    <img src="/images/newimage/sponsors.gif" alt="">
                                                                    <ul class="like-dislike">
                                                                        <li><a class="bg-purple" href="#" title="Save to Pin Post"><i class="fa fa-thumb-tack"></i></a></li>
                                                                        <li><a class="bg-blue" href="#" title="Like Post"><i class="fa fa-thumbs-up"></i></a></li>
                                                                        <li><a class="bg-red" href="#" title="dislike Post"><i class="fa fa-thumbs-down"></i></a></li>
                                                                ...
                                                                <div class="we-video-info">
                                                                    ...
                                                                    <div class="users-thumb-list">
                                                                        <a data-toggle="tooltip" title="Anderw" href="#">
                                                                            <img alt="" src="/images/newimage/userlist-1.jpg">  
                                                                        </a>
                                                                        <a data-toggle="tooltip" title="frank" href="#">
                                                                            <img alt="" src="/images/newimage/userlist-2.jpg">  
                                                                        </a>
                                                                        <a data-toggle="tooltip" title="Sara" href="#">
                                                                            <img alt="" src="/images/newimage/userlist-3.jpg">  
                                                                        </a>
                                                                        <a data-toggle="tooltip" title="Amy" href="#">
                                                                            <img alt="" src="/images/newimage/userlist-4.jpg">  
                                                                        </a>
                                                                        <a data-toggle="tooltip" title="Ema" href="#">
                                                                            <img alt="" src="/images/newimage/userlist-5.jpg">  
                                                                        </a>
                                                            ...
                                                            <div class="coment-area" style="">
                                                                <ul class="we-comet">
                                                                    <li>
                                                                        ...
                                                                        <div class="we-comment">
                                                                            <h5><a href="index.html" title="">Jason borne</a></h5>
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <div class="we-comment">
                                                                            <h5><a href="index.html" title="">Sophia</a></h5>
                                                ...
                                                <div class="central-meta item">
                                                    <div class="user-post">
                                                        <div class="friend-info">
                                                            <figure>
                                                                <img alt="" src="/images/newimage/friend-avatar10.jpg">
                                                            </figure>
                                                            <div class="friend-name">
                                                                <div class="more">
                                                                    <div class="more-post-optns"><i class="fa fa-ellipsis-h"></i>
                                                                ...
                                                                <ins><a title="" href="index.html">Janice Griffith</a></ins>
                                                            ...
                                                            <div class="post-meta">
                                                                <div class="linked-image align-left">
                                                                    <a title="" href="#"><img alt="" src="/images/newimage/page1.jpg"></a>
                                                                </div>
                                                                <div class="detail">
                                                            ...
                                                            <div class="coment-area" style="">
                                                                <ul class="we-comet">
                                                                    <li>
                                                                        <div class="comet-avatar">
                                                                            <img src="/images/newimage/nearly3.jpg" alt="">
                                                                        </div>
                                                                        <div class="we-comment">
                                                                            <h5><a href="index.html" title="">Jason borne</a></h5>
                                                                            <p>we are working for the dance and sing songs. this video is very awesome for the youngster. please vote this video and like our channel</p>
                                                                    ...
                                                                    <li>
                                                                        <div class="comet-avatar">
                                                                            <img src="/images/newimage/comet-4.jpg" alt="">
                                                                        </div>
                                                                        <div class="we-comment">
                                                                            <h5><a href="index.html" title="">Sophia</a></h5>
                                                                            <p>we are working for the dance and sing songs. this video is very awesome for the youngster.
                                                ...
                                                <div class="central-meta item">
                                                    <div class="user-post">
                                                        <div class="friend-info">
                                                            <figure>
                                                                <img src="/images/newimage/friend-avatar10.jpg" alt="">
                                                            </figure>
                                                            <div class="friend-name">
                                                                <div class="more">
                                                                    <div class="more-post-optns"><i class="fa fa-ellipsis-h"></i>
                                                                ...
                                                                <ins><a href="index.html" title="">Mathilda Brinker</a></ins>
                                                            ...
                                                            <div class="post-meta">
                                                                ...
                                                                <ul class="like-dislike">
                                                                    ...
                                                                    <li><a href="#" title="Like Post"><i class="fa fa-thumbs-up"></i></a></li>
                                                                    <li><a href="#" title="dislike Post"><i class="fa fa-thumbs-down"></i></a></li>
                                                                </ul>
                                                                <div class="we-video-info">
                                                                    <ul>
                                                                        <li>
                                                ...
                                                <div class="central-meta item">
                                                    <div class="user-post">
                                                        <div class="friend-info">
                                                            <figure>
                                                                <img src="/images/newimage/nearly6.jpg" alt="">
                                                            </figure>
                                                            <div class="friend-name">
                                                                <div class="more">
                                                                    <div class="more-post-optns"><i class="fa fa-ellipsis-h"></i>
                                                                ...
                                                                <ins><a href="index.html" title="">Sophia</a> shared location</ins>
                                                            ...
                                                            <div class="post-meta">
                                                                ...
                                                                <div class="description">
                                                                    <p>
                                                                        Curabitur Lonely Cat Enjoying in Summer <a href="#" title="">#mypage</a> ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, <a href="index.html" title="">Read More</a>
                                                                    </p>
                                                                </div>
                                                                <div class="we-video-info">
                                                                    <ul>
                                                    ...
                                                    <div class="user-post">
                                                        <div class="friend-info">
                                                            ...
                                                            <div class="friend-name">
                                                                ...
                                                                <ins><a href="index.html" title="">Jack Carter</a> share <a href="#" title="">link</a></ins>
                                                                <span><i class="fa fa-globe"></i> published: january,5 2010 19:PM </span>
                                                            </div>
                                                            <div class="post-meta">
                                                                <figure>
                                                                    ...
                                                                    <img src="/images/newimage/user-post.jpg" alt="">
                                                                        <i>
                                                                ...
                                                                <div class="we-video-info">
                                                                    ...
                                                                    <div class="users-thumb-list">
                                                                        ...
                                                                        <a data-toggle="tooltip" title="Amy" href="#">
                                                                            <img alt="" src="i/images/newimage/userlist-4.jpg">  
                                                                        </a>
                                                                        <a data-toggle="tooltip" title="Ema" href="#">
                                                                            <img alt="" src="/images/newimage/userlist-5.jpg">  
                                                                        </a>
                                                ...
                                                <div class="desc-box-new">
                                                    ...
                                                    <div class="gallery-box" id="photo">
                                                        ...
                                                        if (!empty($gallery)) 
                                                        {
                                                            ...
                                                            <div class="wrapper">
                                                                <div id="big_img">
                                                                    <img src="/public/uploads/gallery/<?= $loggedinUser->id ?>/<?= $gallery[0]['name'] ?>" id="myPicturechange" class="border" />
                                                                </div>
                                                            <div class="table-responsive">
                                                                <div class="thumbnail-inner">
                                                                    ...
                                                                    foreach ($gallery as $pic) {
                                                                        ...
                                                                        <div class="img-wrap">
                                                                            <?php if( $pic['cover'] == 1 ) { ?>
                                                                            <i class="fa fa-image unselectPhoto" selectId="{{ $pic['id'] }}" aria-hidden="true" title="Select photo"> Unset cover photo</i>
                                                                            <?php } else { ?>
                                                                            <i class="fa fa-image selectPhoto" selectId="{{ $pic['id'] }}" aria-hidden="true" title="Select photo"> Set cover photo</i>
                                                                            <?php } ?>
                                                                            <i class="fa fa-trash-o delPhoto" delId="{{ $pic['id'] }}" aria-hidden="true" title="Delete photo"></i>
                                                                            <img class="gallarychangeimg" onclick="gallery();" src="/public/uploads/gallery/<?= $loggedinUser->id ?>/thumb/<?= $pic['name'] ?>" id="/public/uploads/gallery/<?= $loggedinUser->id ?>/<?= $pic['name'] ?>" />
                                                                        </div>
                                                                    <?php } ?> 
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="widget">
                                        ...
                                        <div class="your-page">
                                            ...
                                            <ul class="page-publishes">
                                                ...
                                                <li>
                                                    <span><i class="fa fa-mobile-phone"></i>Post</span><br>
                                                    <span>1.3k</span>
                                                </li>
                                                <li>
