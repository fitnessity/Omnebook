    ...
    constructor(opts = {}) {
        ...
        let html = `<div class="pickcolor" style="width:269px;padding:12px;box-sizing:border-box;">
            ...
            <div class="clearfix" style="margin:25px 0 3px;">
                ...
                <button title="${this.out('W')}" data-color="#ffffff" style="background:#ffffff;border:#e7e7e7 1px solid;width:35px;height:35px;line-height:35px;font-size:10px;border-right:none;">${this.out('W')}</button>
                <button title="${this.out('Clear')}" data-color="" class="clear classic" style="width:140px;height:35px;line-height:35px;border:#e7e7e7 1px solid;border-right:none;">${this.out('Clear')}</button>
                <button title="${this.out('More')}" class="input-hsl" style="background:#ffffff;border:#e7e7e7 1px solid;width:35px;height:35px;line-height:35px;font-size:10px;"><svg class="is-icon-flex" style="fill: rgba(0, 0, 0, 0.45);width:13px;height:13px;"><use xlink:href="#ion-more"></use></svg></button>
            </div>
            <div style="display:flex">
                ...
                <button title="${this.out('Apply')}" class="input-ok" style="height:35px;border: 1px solid rgb(199, 199, 199);border-left:none;margin-top:8px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);"><use xlink:href="#icon-ok"></use></svg></use></svg></svg></button>
            </div>
        </div>`;
            ...
            <div style="max-width:271px;padding:0;">
                ...
                <div style="padding:12px 12px 12px">
                    ...
                    <div style="display:flex">
                        ...
                        <input class="input-text" type="text" style="width:209px;height:35px;margin-top:8px;font-size:13px;"/>
                        <button title="${this.out('Apply')}" class="input-ok" style="display:none;height:35px;border: 1px solid rgb(199, 199, 199);border-left:none;margin-top:8px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);"><use xlink:href="#icon-ok"></use></svg></use></svg></svg></button>
                    </div>
