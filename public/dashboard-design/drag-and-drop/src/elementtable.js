                ...
                <div style="padding:0">
                    ...
                    <div id="divTableLayout" class="is-tab-content" data-group="table">
                        <div class="is-settings clearfix" style="margin-bottom:0;">
                            ...
                            <div>
                                <button title="${util.out('Above')}" data-table-cmd="rowabove" title="Insert Row (Above)" style="width:100px;margin-right:5px"> ${util.out('Above')} </button>
                                <button title="${util.out('Below')}" data-table-cmd="rowbelow" title="Insert Row (Below)" style="width:100px;"> ${util.out('Below')} </button>
                            </div> 
                        </div>
                        <div class="is-settings clearfix" style="margin-bottom:0;">
                            <div>Insert Column:</div>
                            <div>
                                <button title="${util.out('Left')}" data-table-cmd="columnleft" title="Insert Column (Left)" style="width:100px;margin-right:5px"> ${util.out('Left')} </button> 
                                <button title="${util.out('Right')}" data-table-cmd="columnright" title="Insert Column (Right)" style="width:100px;"> ${util.out('Right')} </button> 
                            </div> 
                        </div>
                        <div class="is-settings clearfix" style="margin-bottom:0;">
                            <div>Delete:</div>
                            <div>
                                <button title="${util.out('Row')}" data-table-cmd="delrow" title="Delete Row" style="width:100px;margin-right:5px"> ${util.out('Row')} </button> 
                                <button title="${util.out('Column')}" data-table-cmd="delcolumn" title="Delete Column" style="width:100px;"> ${util.out('Column')} </button> 
                            </div> 
                        </div>
                        <div class="is-settings clearfix" style="margin-bottom:0;">
                            <div>${util.out('Merge')}:</div>
                                <button title="${util.out('Merge Cell')}" data-table-cmd="mergecell" title="Merge Cell" style="width:205px"> Merge Cell </button> 
                            </div> 
                        </div>
                    </div>
                </div>
