    ...
    addSnippet(html, bSnippet, noedit) { 
        ...
        if (bSnippet && (mode === 'cell' || mode === 'cell-left' || mode === 'cell-right')) {
            ...
            */
            ...
            // NEW: See newsletterbuilder.js line 328
            // OLD: See newsletterbuilder-jquery.js addSnippet() line 16529
            ...
            */
            ...
            // NEW: See newsletterbuilder.js line 341 AND newsletterbuilder-jquery.js (addContentMore) line 11526
            // OLD: See newsletterbuilder-jquery.js (addContentMore) line 11526
    ...
    checkEmpty() {
        ...
        Array.prototype.forEach.call(builders, (builder) => {
            ...
            if(empty) {
                ...
                if(!emptyinfo) {
                    builder.innerHTML = `<button class="row-add-initial">${this.out('Empty')}<br><span>${this.out('+ Click to add content')}</span></div>`;
