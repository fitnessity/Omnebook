...
import Moveable from '../node_modules/moveable/dist/moveable.esm.js';
...
export class Image {
    ...
    constructor(builder) {
        ...
        if(!imageTool) {
            ...
            dom.addEventListener(fileLargerImage1, 'change', () => {
            ...
            dom.addEventListener(fileLargerImage2, 'change', () => {
