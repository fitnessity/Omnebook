...
Route::get('/clear-cache', function () {
    ...
    Route::name('business.')->prefix('/business/{business_id}')->namespace('Business')->middleware('auth', 'business_scope')->group(function () {
        ...
        Route::post('schedulers/store_edit','SchedulerController@storeedit')->name('schedulers.store_edit');
        ...
        Route::get('services/get-schedule-data-edit', 'ServiceController@getScheduleDataEdit')->name('service.get-schedule-data-edit');
    ...
    Route::prefix('/admin')->group(function() {
        ...
        Route::get('/book/delete/{id}', 'Admin\BookactivityController@delete'); /*** book an activity end ****/
    ...
    Route::name('design.')->prefix('/design')->middleware('auth')->group(function () {
        ...
        Route::get('/page_not_found','DesignController@page_not_found')->name('page_not_found');
    });
});
?>